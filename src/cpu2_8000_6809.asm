...
8184: 96 03       LDA    $03
8186: 48          ASLA
8187: AD 96       JSR    [A,X]        ; [indirect_jump] [nb_entries=14]
8189: 96 1A       LDA    $1A
...
9C1E: A6 09       LDA    $9,X
9C20: 48          ASLA
9C21: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=9]
...
9D0B: A6 09       LDA    $9,X
9D0D: 48          ASLA
9D0E: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=9]
...
9E6E: A6 09       LDA    $9,X
9E70: 48          ASLA
9E71: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=17]
...
9FA1: A6 09       LDA    $9,X
9FA3: 48          ASLA
9FA4: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=9]
9FA6: EE 10       LDU    -$10,X
9FA8: A6 41       LDA    $1,U
9FAA: 8A 01       ORA    #$01
9FAC: A7 41       STA    $1,U
...
A1BA: A6 09       LDA    $9,X
A1BC: 48          ASLA
A1BD: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=6]
A1BF: 86 19       LDA    #$19
A1C1: A7 01       STA    $1,X
A1C3: A7 07       STA    $7,X
...
A1C8: A6 09       LDA    $9,X
A1CA: 48          ASLA
A1CB: 6E D6       JMP    [A,U]        ; [indirect_jump]
A1CD: 86 1A       LDA    #$1A
A1CF: A7 01       STA    $1,X
A1D1: A7 07       STA    $7,X
...
A1E8: A6 09       LDA    $9,X
A1EA: 48          ASLA
A1EB: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=5]
A1ED: 6A 0A       DEC    $A,X
A1EF: 27 01       BEQ    $A1F2
A1F1: 39          RTS
...
A3BB: A6 09       LDA    $9,X
A3BD: 48          ASLA
A3BE: 6E D6       JMP    [A,U]        ; [indirect_jump]
A3C0: 86 1E       LDA    #$1E
A3C2: A7 01       STA    $1,X
A3C4: A7 07       STA    $7,X
...
A528: A6 09       LDA    $9,X
A52A: 48          ASLA
A52B: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=5]
A52D: 86 A1       LDA    #$A1
A52F: A7 01       STA    $1,X
A531: A7 07       STA    $7,X
...
A536: A6 09       LDA    $9,X
A538: 48          ASLA
A539: 6E D6       JMP    [A,U]        ; [indirect_jump]
A53B: 86 A2       LDA    #$A2
A53D: A7 01       STA    $1,X
A53F: A7 07       STA    $7,X
...
A544: A6 09       LDA    $9,X
A546: 48          ASLA
A547: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=5]
A549: A6 01       LDA    $1,X
A54B: 84 03       ANDA   #$03
A54D: 8B A4       ADDA   #$A4
A54F: A7 01       STA    $1,X
...
A6DF: A6 09       LDA    $9,X
A6E1: 48          ASLA
A6E2: 6E D6       JMP    [A,U]        ; [indirect_jump]
A6E4: 86 A6       LDA    #$A6
A6E6: A7 01       STA    $1,X
A6E8: A7 07       STA    $7,X
...
A85A: CE A8 35    LDU    #jump_table_a835
A85D: 96 0A       LDA    $0A
A85F: 84 0C       ANDA   #$0C
A861: 44          LSRA
A862: EC C6       LDD    A,U
...
A86C: A6 09       LDA    $9,X
A86E: 48          ASLA
A86F: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
B2AF: C4 FC       ANDB   #$FC
B2B1: 54          LSRB
B2B2: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=46]
B2B4: 0A 3B       DEC    $3B
B2B6: 26 01       BNE    $B2B9
B2B8: 39          RTS
...
B44A: C4 FC       ANDB   #$FC
B44C: 54          LSRB
B44D: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=54]
...
B81B: A6 09       LDA    $9,X
B81D: 48          ASLA
B81E: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=11]
B820: 6A 0A       DEC    $A,X
B822: 27 01       BEQ    $B825
B824: 39          RTS
...
B8C7: A6 09       LDA    $9,X
B8C9: 48          ASLA
B8CA: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=3]
...
C04A: A6 09       LDA    $9,X
C04C: 48          ASLA
C04D: 6E D6       JMP    [A,U]        ; [indirect_jump]
C04F: C0 67       SUBB   #$67
C051: C0 B0       SUBB   #$B0
C053: C0 B0       SUBB   #$B0
C055: C0 67       SUBB   #$67
...
C283: A6 09       LDA    $9,X
C285: 48          ASLA
C286: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=17]
C288: 86 40       LDA    #$40
C28A: A7 05       STA    $5,X
C28C: EC 1C       LDD    -$4,X
...
C2A6: A6 09       LDA    $9,X
C2A8: 48          ASLA
C2A9: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=9]
C2AB: 86 80       LDA    #$80
C2AD: A7 05       STA    $5,X
C2AF: EC 1C       LDD    -$4,X
...
CEC6: 80 40       SUBA   #$40
CEC8: 48          ASLA
CEC9: AD D6       JSR    [A,U]        ; [indirect_jump] [nb_entries=14]
CECB: 0A 55       DEC    $55
CECD: 26 01       BNE    $CED0
CECF: 39          RTS
...
CF2D: 48          ASLA
CF2E: 6E D6       JMP    [A,U]        ; [indirect_jump]
