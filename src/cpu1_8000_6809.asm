...
80EC: 5F          CLRB
80ED: 8E 80 00    LDX    #$8000
80F0: B7 80 00    STA    $8000
80F3: EB 80       ADDB   ,X+
...
857B: 91 03       CMPA   $03
857D: 22 08       BHI    $8587
857F: CE 85 A2    LDU    #$85A2
8582: 96 02       LDA    $02
8584: 48          ASLA
8585: AD D6       JSR    [A,U]
8587: 96 19       LDA    $19
8589: B7 68 00    STA    $6800
858C: B7 80 00    STA    $8000
858F: B7 84 00    STA    $8400
8592: 3B          RTI
8593: BD 81 CC    JSR    $81CC
8596: 96 19       LDA    $19
8598: B7 68 00    STA    $6800
859B: B7 80 00    STA    $8000
859E: B7 84 00    STA    $8400
85A1: 3B          RTI
85A2: 83 55 85    SUBD   #$5585
85A5: B0 8F 10    SUBA   $8F10
85A8: 90 FB       SUBA   $FB
85AA: 92 2E       SBCA   $2E
85AC: 99 01       ADCA   $01
85AE: 9B EF       ADDA   $EF
...
860B: 6A 61       DEC    $1,S
860D: 26 DD       BNE    $85EC
860F: B7 80 00    STA    $8000
8612: 35 86       PULS   D,PC
8614: B6 54 2B    LDA    $542B
8617: 48          ASLA
8618: CE 86 1D    LDU    #$861D
861B: 6E D6       JMP    [A,U]
861D: 86 27       LDA    #$27
861F: 86 33       LDA    #$33
8621: 86 46       LDA    #$46
8623: 89 37       ADCA   #$37
8625: 8C 87 B6    CMPX   #$87B6
8628: 5F          CLRB
...
8D1B: 0C 16       INC    $16
8D1D: 0A 12       DEC    $12
8D1F: 17 FF 1B    LBSR   $8C3D
8D22: 18          X18
8D23: 16 FF FF    LBRA   $8D25
8D26: 17 10 0C    LBSR   $9D35
8D29: 16 0A 12    LBRA   $973E
8D2C: 17 FF 1B    LBSR   $8C4A
8D2F: 18          X18
8D30: 16 FF FF    LBRA   $8D32
8D33: 18          X18
8D34: 14          XHCF
8D35: 0B 1C       XDEC   $1C
8D37: 1E 0B       EXG    D,DP
8D39: FF 1B 18    STU    $1B18
8D3C: 16 FF FF    LBRA   $8D3E
8D3F: 17 10 0B    LBSR   $9D4D
8D42: 1C 1E       ANDCC  #$1E
8D44: 0B FF       XDEC   $FF
8D46: 1B          NOP
8D47: 18          X18
8D48: 16 FF FF    LBRA   $8D4A
8D4B: 18          X18
8D4C: 14          XHCF
8D4D: 0C 1B       INC    $1B
8D4F: 0A 16       DEC    $16
8D51: FF FF FF    STU    $FFFF
8D54: FF FF FF    STU    $FFFF
8D57: FF 17 10    STU    $1710
8D5A: 0C 1B       INC    $1B
8D5C: 0A 16       DEC    $16
8D5E: FF FF FF    STU    $FFFF
8D61: FF FF FF    STU    $FFFF
8D64: FF 18 14    STU    $1814
8D67: 0B 0C       XDEC   $0C
8D69: 1E 1C       EXG    X,inv
8D6B: 1D          SEX
8D6C: 18          X18
8D6D: 16 FF FF    LBRA   $8D6F
8D70: FF 17 10    STU    $1710
8D73: 0B 0C       XDEC   $0C
8D75: 1E 1C       EXG    X,inv
8D77: 1D          SEX
8D78: 18          X18
8D79: 16 FF FF    LBRA   $8D7B
8D7C: FF 18 14    STU    $1814
8D7F: 1E 0C       EXG    D,inv
8D81: 18          X18
8D82: 12          NOP
8D83: 17 FF 01    LBSR   $8C87
8D86: FF FF FF    STU    $FFFF
8D89: FF FF FF    STU    $FFFF
8D8C: FF FF FF    STU    $FFFF
8D8F: 0C 18       INC    $18
8D91: 12          NOP
8D92: 17 FF FF    LBSR   $8D94
8D95: FF FF 0C    STU    $FF0C
8D98: 1B          NOP
8D99: 0E 0D       JMP    $0D
8D9B: 12          NOP
8D9C: 1D          SEX
...
8D9F: 0C 18       INC    $18
8DA1: 12          NOP
8DA2: 17 FF 02    LBSR   $8CA7
8DA5: FF FF FF    STU    $FFFF
8DA8: FF FF FF    STU    $FFFF
8DAB: FF FF FF    STU    $FFFF
8DAE: 0C 18       INC    $18
8DB0: 12          NOP
8DB1: 17 FF FF    LBSR   $8DB3
8DB4: FF FF 0C    STU    $FF0C
8DB7: 1B          NOP
8DB8: 0E 0D       JMP    $0D
8DBA: 12          NOP
8DBB: 1D          SEX
...
8DBE: 0C 18       INC    $18
8DC0: 12          NOP
8DC1: 17 FF 01    LBSR   $8CC5
8DC4: FF FF FF    STU    $FFFF
8DC7: FF FF FF    STU    $FFFF
8DCA: FF FF FF    STU    $FFFF
8DCD: 0C 18       INC    $18
8DCF: 12          NOP
8DD0: 17 1C FF    LBSR   $AAD2
8DD3: FF FF 0C    STU    $FF0C
8DD6: 1B          NOP
8DD7: 0E 0D       JMP    $0D
8DD9: 12          NOP
8DDA: 1D          SEX
8DDB: FF 1E 0C    STU    $1E0C
8DDE: 18          X18
8DDF: 12          NOP
8DE0: 17 FF 02    LBSR   $8CE5
8DE3: FF FF FF    STU    $FFFF
8DE6: FF FF FF    STU    $FFFF
8DE9: FF FF FF    STU    $FFFF
8DEC: 0C 18       INC    $18
8DEE: 12          NOP
8DEF: 17 1C FF    LBSR   $AAF1
8DF2: FF FF 0C    STU    $FF0C
8DF5: 1B          NOP
8DF6: 0E 0D       JMP    $0D
8DF8: 12          NOP
8DF9: 1D          SEX
8DFA: FF 1E 0C    STU    $1E0C
8DFD: 18          X18
8DFE: 12          NOP
8DFF: 17 FF 01    LBSR   $8D03
8E02: FF FF FF    STU    $FFFF
8E05: FF FF FF    STU    $FFFF
8E08: FF FF FF    STU    $FFFF
8E0B: 0C 18       INC    $18
8E0D: 12          NOP
8E0E: 17 FF FF    LBSR   $8E10
8E11: FF FF 0C    STU    $FF0C
8E14: 1B          NOP
8E15: 0E 0D       JMP    $0D
8E17: 12          NOP
8E18: 1D          SEX
8E19: FF 1E 0C    STU    $1E0C
8E1C: 18          X18
8E1D: 12          NOP
8E1E: 17 FF 02    LBSR   $8D23
8E21: FF FF FF    STU    $FFFF
8E24: FF FF FF    STU    $FFFF
8E27: FF FF FF    STU    $FFFF
8E2A: 0C 18       INC    $18
8E2C: 12          NOP
8E2D: 17 FF FF    LBSR   $8E2F
8E30: FF FF 0C    STU    $FF0C
8E33: 1B          NOP
8E34: 0E 0D       JMP    $0D
8E36: 12          NOP
8E37: 1D          SEX
8E38: FF 07 0A    STU    $070A
8E3B: 1D          SEX
8E3C: 1D          SEX
8E3D: 1B          NOP
8E3E: 0A 0C       DEC    $0C
...
8E41: 08 1C       ASL    $1C
8E43: 18          X18
8E44: 1E 17       EXG    X,inv
8E46: 0D FF       TST    $FF
8E48: FF FF 08    STU    $FF08
8E4B: 17 18 FF    LBSR   $A74D
8E4E: 1C 18       ANDCC  #$18
8E50: 1E 17       EXG    X,inv
8E52: 0D 09       TST    $09
8E54: 0A 15       DEC    $15
8E56: 0B 0A       XDEC   $0A
8E58: 1D          SEX
...
8E5D: 05 0B       LSR    $0B
8E5F: 18          X18
8E60: 17 1E 1C    LBSR   $AC7F
8E63: 11 07 00    ASR    $00
8E66: 00 00       NEG    $00
8E68: 00 FF       NEG    $FF
8E6A: 37 02       PULU   A
8E6C: 00 00       NEG    $00
...
8E88: 1D          SEX
8E89: 12          NOP
8E8A: 16 0E 1B    LBRA   $9CA8
8E8D: 07 01       ASR    $01
8E8F: 02 00       XNC    $00
8E91: FF 1C 0E    STU    $1C0E
8E94: 0C 07       INC    $07
8E96: 01 05       NEG    $05
8E98: 00 FF       NEG    $FF
8E9A: 1C 0E       ANDCC  #$0E
...
8EA6: 1D          SEX
8EA7: 22 05       BHI    $8EAE
8EA9: 17 18 16    LBSR   $A6C2
8EAC: 0A 15       DEC    $15
8EAE: 05 0E       LSR    $0E
8EB0: 0A 1C       DEC    $1C
8EB2: 22 FF       BHI    $8EB3
8EB4: 11 0C 0A    INC    $0A
8EB7: 0B 12       XDEC   $12
8EB9: 17 0E 1D    LBSR   $9CD9
8EBC: FF FF FF    STU    $FFFF
8EBF: FF FF FF    STU    $FFFF
8EC2: 1D          SEX
8EC3: 22 19       BHI    $8EDE
8EC5: 0E 0C       JMP    $0C
8EC7: 0C 18       INC    $18
8EC9: 17 1D 12    LBSR   $ABDE
8ECC: 17 1E 0A    LBSR   $ACD9
8ECF: 1D          SEX
8ED0: 12          NOP
8ED1: 18          X18
8ED2: 17 06 1C    LBSR   $94F1
8ED5: 0E 15       JMP    $15
8ED7: 0E 0C       JMP    $0C
8ED9: 1D          SEX
8EDA: 03 22       COM    $22
...
8EDE: 03 17       COM    $17
8EE0: 18          X18
8EE1: FF 01 06    STU    $0106
8EE4: 01 03       NEG    $03
8EE6: 05 1C       LSR    $1C
8EE8: 18          X18
8EE9: 1E 17       EXG    X,inv
8EEB: 0D 05       TST    $05
8EED: 19          DAA
8EEE: 1C 10       ANDCC  #$10
8EF0: FF FF 05    STU    $FF05
8EF3: 0F 16       CLR    $16
8EF5: FF FF FF    STU    $FFFF
8EF8: 05 1F       LSR    $1F
8EFA: 18          X18
8EFB: 12          NOP
8EFC: 0C 0E       INC    $0E
...
8F00: 12          NOP
8F01: 19          DAA
8F02: FF 1C 20    STU    $1C20
8F05: FF 0A 08    STU    $0A08
8F08: 0D 12       TST    $12
8F0A: 19          DAA
8F0B: FF 1C 20    STU    $1C20
8F0E: FF 0B 7D    STU    $0B7D
8F11: 42          XNCA
8F12: 3D          MUL
8F13: 26 24       BNE    $8F39
8F15: 96 04       LDA    $04
...
90BF: 3A          ABX
90C0: E6 E4       LDB    ,S
90C2: B7 80 00    STA    $8000
90C5: 6A 62       DEC    $2,S
90C7: 26 E2       BNE    $90AB
90C9: 32 63       LEAS   $3,S
90CB: 39          RTS
90CC: 86 19       LDA    #$19
90CE: B7 68 00    STA    $6800
...
95AD: 84 0F       ANDA   #$0F
95AF: ED C1       STD    ,U++
95B1: 35 82       PULS   A,PC
95B3: 05 1D       LSR    $1D
95B5: 18          X18
95B6: 19          DAA
95B7: FF 05 12    STU    $0512
95BA: 1C 0C       ANDCC  #$0C
95BC: 18          X18
95BD: 1B          NOP
95BE: 0E FF       JMP    $FF
95C0: FF 0A 1B    STU    $0A1B
95C3: 0E 0A       JMP    $0A
95C5: FF FF 12    STU    $FF12
95C8: 17 12 2B    LBSR   $A7F6
95CB: 1D          SEX
95CC: 03 01       COM    $01
95CE: 1C 1D       ANDCC  #$1D
95D0: 03 02       COM    $02
95D2: 17 0D 03    LBSR   $A2D8
95D5: 03 1B       COM    $1B
95D7: 0D 03       TST    $03
95D9: 04 1D       LSR    $1D
95DB: 11 03 05    COM    $05
95DE: 1D          SEX
95DF: 11 0A 0A    DEC    $0A
95E2: 0A C6       DEC    $C6
95E4: 05 CE       LSR    $CE
95E6: 54          LSRB
95E7: 00 8E       NEG    $8E
...
9622: 00 08       NEG    $08
9624: 00 02       NEG    $02
9626: 16 0A 0B    LBRA   $A034
9629: 00 04       NEG    $04
962B: 00 01       NEG    $01
962D: 16 19 12    LBRA   $AF42
9630: CE 96 39    LDU    #$9639
...
990D: 0D D8       TST    $D8
990F: 26 06       BNE    $9917
9911: CE 99 2D    LDU    #$992D
9914: 48          ASLA
9915: 6E D6       JMP    [A,U]
9917: CE 99 31    LDU    #$9931
991A: 48          ASLA
991B: 6E D6       JMP    [A,U]
...
9AF9: 08 0C       ASL    $0C
9AFB: 18          X18
9AFC: 17 1D FF    LBSR   $B8FE
9AFF: FF FF FF    STU    $FFFF
9B02: C6 FC       LDB    #$FC
...
A174: 23 01       BLS    $A177
A176: 39          RTS
A177: CE A1 7D    LDU    #$A17D
A17A: 48          ASLA
A17B: 6E D6       JMP    [A,U]
A17D: A1 85       CMPA   B,X
A17F: A1 8F       CMPA   ,W
A181: A1 9E       CMPA   [W,X]
A183: A1 B0 0C 06 CMPA   [$0C06,W]
A187: 0F E8       CLR    $E8
...
A31E: A4 25       ANDA   $5,Y
A320: A4 66       ANDA   $6,S
A322: A4 BC A4    ANDA   [$A2C9,PCR]
A325: D1 A4       CMPB   $A4
A327: FD A5 3B    STD    $A53B
A32A: 0C 06       INC    $06
A32C: 0F E8       CLR    $E8
...
A6D7: 0C CF       INC    $CF
A6D9: 39          RTS
A6DA: CE A6 E2    LDU    #$A6E2
A6DD: 96 06       LDA    $06
A6DF: 48          ASLA
A6E0: 6E D6       JMP    [A,U]
A6E2: A6 E6       LDA    A,S
A6E4: A8 70       EORA   -$10,S
...
ABEB: 08 0C       ASL    $0C
ABED: 18          X18
ABEE: 17 1D FF    LBSR   $C9F0
ABF1: FF FF FF    STU    $FFFF
ABF4: C6 FC       LDB    #$FC
...
AC82: 23 01       BLS    $AC85
AC84: 39          RTS
AC85: CE AC 8B    LDU    #$AC8B
AC88: 48          ASLA
AC89: 6E D6       JMP    [A,U]
AC8B: AC A3       CMPX   ,--Y
AC8D: AC AD AC BC CMPX   $594D,PCR
AC91: AC D1       CMPX   [,U++]
AC93: AD 58       JSR    -$8,U
AC95: AD 99 AD CC JSR    [-$5234,X]
AC99: AE 19       LDX    -$7,X
AC9B: AE 4A       LDX    $A,U
AC9D: AE 66       LDX    $6,S
AC9F: AE 88 AE    LDX    -$52,X
ACA2: E7 0C       STB    $C,X
ACA4: 06 0F       ROR    $0F
ACA6: E8 BD 84 E0 EORB   [$318A,PCR]
...
AFE9: 05 16       LSR    $16
AFEB: 0A 17       DEC    $17
AFED: FF FF 0D    STU    $FF0D
AFF0: 30 31       LEAX   -$F,Y
AFF2: FF 01 09    STU    $0109
AFF5: 08 06       ASL    $06
AFF7: FF 17 0A    STU    $170A
AFFA: 16 0C 18    LBRA   $BC15
AFFD: 13          SYNC
AFFE: 0A 15       DEC    $15
B000: 15          XHCF
B001: FF 1B 12    STU    $1B12
B004: 10          FCB    $10
B005: 11 1D       SEX
B007: 1C FF       ANDCC  #$FF
B009: 1B          NOP
B00A: 0E 1C       JMP    $1C
B00C: 0E 1B       JMP    $1B
B00E: 1F 0E       TFR    D,inv
B010: 0D 0A       TST    $0A
B012: 0C 1B       INC    $1B
B014: 0E 0D       JMP    $0D
B016: 12          NOP
B017: 1D          SEX
B018: FF FF FF    STU    $FFFF
B01B: FF 07 0A    STU    $070A
B01E: 1D          SEX
B01F: 1D          SEX
B020: 1B          NOP
B021: 0A 0C       DEC    $0C
...
B03A: 1B          NOP
B03B: 22 FF       BHI    $B03C
B03D: FF FF 08    STU    $FF08
B040: 0A 1B       DEC    $1B
B042: 0E 0A       JMP    $0A
B044: FF FF FF    STU    $FFFF
B047: FF 04 17    STU    $0417
B04A: 0A 16       DEC    $16
B04C: 0E 01       JMP    $01
B04E: 01 01       NEG    $01
B050: 02 01       XNC    $01
...
B058: 1D          SEX
B059: 12          NOP
B05A: 16 0E 1B    LBRA   $BE78
B05D: FF FF FF    STU    $FFFF
B060: 10 1D       SEX
B062: 18          X18
B063: FF 0C 18    STU    $0C18
B066: 17 1D 12    LBSR   $CD7B
B069: 17 1E 0E    LBSR   $CE7A
B06C: FF 10 0A    STU    $100A
B06F: 16 0E 0B    LBRA   $BE7D
B072: 12          NOP
B073: 17 1C 0E    LBSR   $CC84
B076: 1B          NOP
B077: 1D          SEX
B078: FF 0C 18    STU    $0C18
B07B: 12          NOP
B07C: 17 04 19    LBSR   $B498
B07F: 1E 1C       EXG    X,inv
B081: 11 0D 1D    TST    $1D
B084: 18          X18
B085: FF 1C 1D    STU    $1C1D
B088: 0A 1B       DEC    $1B
B08A: 1D          SEX
B08B: FF 19 1E    STU    $191E
B08E: 1C 11       ANDCC  #$11
B090: 16 18 17    LBRA   $C8AA
B093: 15          XHCF
B094: 22 FF       BHI    $B095
B096: 01 FF       NEG    $FF
B098: 19          DAA
...
B09C: 0E 1B       JMP    $1B
B09E: 2B 1C       BMI    $B0BC
B0A0: FF 0B 1E    STU    $0B1E
B0A3: 1D          SEX
B0A4: 1D          SEX
B0A5: 18          X18
B0A6: 17 16 01    LBSR   $C6AA
B0A9: FF 18 1B    STU    $181B
B0AC: FF 02 FF    STU    $02FF
B0AF: 19          DAA
B0B0: 15          XHCF
B0B1: 0A 22       DEC    $22
B0B3: 0E 1B       JMP    $1B
B0B5: 1C 2B       ANDCC  #$2B
B0B7: FF 0B 1E    STU    $0B1E
B0BA: 1D          SEX
B0BB: 1D          SEX
B0BC: 18          X18
B0BD: 17 0A 19    LBSR   $BAD9
B0C0: 15          XHCF
B0C1: 0A 22       DEC    $22
B0C3: 0E 1B       JMP    $1B
B0C5: FF 18 17    STU    $1817
B0C8: 0E 0A       JMP    $0A
B0CA: 19          DAA
B0CB: 15          XHCF
B0CC: 0A 22       DEC    $22
B0CE: 0E 1B       JMP    $1B
B0D0: FF 1D 20    STU    $1D20
B0D3: 18          X18
B0D4: 0A 1B       DEC    $1B
B0D6: 0E 0A       JMP    $0A
B0D8: 0D 22       TST    $22
B0DA: FF 25 FF    STU    $25FF
B0DD: FF FF 0A    STU    $FF0A
B0E0: FF FF 10    STU    $FF10
B0E3: 18          X18
B0E4: FF FF 25    STU    $FF25
B0E7: FF FF FF    STU    $FFFF
B0EA: 0A 10       DEC    $10
B0EC: 0A 16       DEC    $16
B0EE: 0E FF       JMP    $FF
B0F0: FF 18 1F    STU    $181F
B0F3: 0E 1B       JMP    $1B
B0F5: 12          NOP
B0F6: 16 12 1C    LBRA   $C315
B0F9: 1C 12       ANDCC  #$12
B0FB: 18          X18
B0FC: 17 FF 0C    LBSR   $B00B
B0FF: 18          X18
B100: 16 19 15    LBRA   $CA18
B103: 0E 1D       JMP    $1D
B105: 0E FF       JMP    $FF
B107: 25 0A       BCS    $B113
B109: 0B 1E       XDEC   $1E
...
B10C: 15          XHCF
B10D: 0E 1D       JMP    $1D
B10F: FF FF FF    STU    $FFFF
B112: FF 0A 16    STU    $0A16
B115: 10 FF 0B 15 STS    $0B15
B119: 1D          SEX
B11A: FF FF FF    STU    $FFFF
B11D: FF 0D 15    STU    $0D15
B120: 12          NOP
B121: 0F 0E       CLR    $0E
B123: FF FF FF    STU    $FFFF
B126: FF FF FF    STU    $FFFF
B129: FF FF FF    STU    $FFFF
B12C: 0F 0C       CLR    $0C
B12E: 18          X18
B12F: 17 10 1B    LBSR   $C14D
B132: 0A 1D       DEC    $1D
B134: 1E 15       EXG    X,PC
B136: 0A 1D       DEC    $1D
B138: 12          NOP
B139: 18          X18
B13A: 17 1C 0F    LBSR   $CD4C
B13D: 1C 1D       ANDCC  #$1D
B13F: 18          X18
B140: 1B          NOP
B141: 22 FF       BHI    $B142
B143: FF FF FF    STU    $FFFF
B146: 0C 15       INC    $15
B148: 0E 0A       JMP    $0A
B14A: 1B          NOP
B14B: FF 0F 0A    STU    $0F0A
B14E: 1B          NOP
B14F: 0E 0A       JMP    $0A
B151: FF FF FF    STU    $FFFF
B154: FF FF 0C    STU    $FF0C
B157: 15          XHCF
B158: 0E 0A       JMP    $0A
B15A: 1B          NOP
B15B: FF 08 1D    STU    $081D
B15E: 12          NOP
B15F: 16 0E FF    LBRA   $C061
B162: FF FF FF    STU    $FFFF
B165: 17 0A 0D    LBSR   $BB75
B168: 1F 0A       TFR    D,CC
B16A: 17 0C 0E    LBSR   $BD7B
B16D: FF 1D 18    STU    $1D18
B170: FF 11 12    STU    $1112
B173: 10          FCB    $10
B174: 11 0E 1B    JMP    $1B
B177: FF 0A 1B    STU    $0A1B
B17A: 0E 0A       JMP    $0A
B17C: 1C 02       ANDCC  #$02
B17E: 0B 22       XDEC   $22
B180: 19          DAA
...
B183: 15          XHCF
B184: 0D 12       TST    $12
B186: 17 10 FF    LBSR   $C288
B189: 0D 18       TST    $18
B18B: 20 17       BRA    $B1A4
B18D: FF 1C 1D    STU    $1C1D
B190: 0A 1B       DEC    $1B
B192: 1D          SEX
B193: FF 0B 1E    STU    $0B1E
B196: 1D          SEX
B197: 1D          SEX
B198: 18          X18
B199: 17 1E 2A    LBSR   $CFC6
B19C: FF 16 18    STU    $1618
B19F: 1F 12       TFR    X,Y
B1A1: 17 10 FF    LBSR   $C2A3
B1A4: 0C 18       INC    $18
B1A6: 17 1D 1B    LBSR   $CEC4
B1A9: 18          X18
B1AA: 15          XHCF
B1AB: FF 1D 18    STU    $1D18
B1AE: FF 1D 11    STU    $1D11
B1B1: 0E FF       JMP    $FF
B1B3: 1B          NOP
B1B4: 12          NOP
B1B5: 10          FCB    $10
...
B2DF: D0 53       SUBB   $53
B2E1: E0 53       SUBB   -$D,U
B2E3: F0 00 00    SUBB   >$0000
B2E6: 10 00 20    NEG    $20
B2E9: 00 30       NEG    $30
B2EB: 00 10       NEG    $10
B2ED: 8E B2 DC    LDX    #$B2DC
...
B419: 58          ASLB
B41A: 3A          ABX
B41B: CE B4 27    LDU    #$B427
B41E: A6 84       LDA    ,X
B420: 2B 0F       BMI    $B431
B422: 84 1C       ANDA   #$1C
B424: 44          LSRA
B425: 6E D6       JMP    [A,U]
B427: B4 31 B1    ANDA   $31B1
B42A: B9 B1 FE    ADCA   $B1FE
B42D: B2 EC B3    SBCA   $ECB3
B430: 2E 0C       BGT    $B43E
B432: B4 39 86    ANDA   $3986
B435: 18          X18
B436: B7 68 00    STA    $6800
...
B610: E8 52       EORB   -$E,U
B612: E9 26       ADCB   $6,Y
B614: E8 BC E9    EORB   [$B600,PCR]
B617: 90 96       SUBA   $96
B619: 36 26       PSHU   Y,D
B61B: 05 97       LSR    $97
B61D: 32 97       LEAS   [E,X]
B61F: 38 39       XANDCC #$39
...
B662: 20 C6       BRA    $B62A
B664: B6 E6 B7    LDA    $E6B7
B667: 50          NEGB
B668: B7 BA B8    STA    $BAB8
B66B: 24 20       BCC    $B68D
B66D: FE DC 8A    LDU    $DC8A
B670: E3 1C       ADDD   -$4,X
B672: ED 1C       STD    -$4,X
B674: DC 88       LDD    $88
B676: E3 1A       ADDD   -$6,X
...
B700: C0 50       SUBB   #$50
B702: C2 28       SBCB   #$28
B704: BE 9B BE    LDX    $9BBE
B707: 9B C1       ADDA   $C1
B709: D6 BF       LDB    $BF
B70B: 37 BE       PULU   D,DP,X,Y,PC
B70D: 9B BE       ADDA   $BE
B70F: 9B BF       ADDA   $BF
B711: 63 BE       COM    [W,Y]
B713: 9B BE       ADDA   $BE
...
B723: 9B BE       ADDA   $BE
B725: 9B B8       ADDA   $B8
B727: BF BE 9B    STX    $BE9B
B72A: BE 9B BE    LDX    $9BBE
B72D: 9B BE       ADDA   $BE
B72F: 9B C1       ADDA   $C1
B731: D6 BE       LDB    $BE
B733: 9B BE       ADDA   $BE
...
B74D: 9B BE       ADDA   $BE
B74F: 9B C7       ADDA   $C7
B751: E1 C9 C7 C9 CMPB   -$3837,U
B755: C7 C9       XSTB   #$C9
B757: C7 C9       XSTB   #$C9
B759: C7 C9       XSTB   #$C9
B75B: C7 CA       XSTB   #$CA
B75D: E7 CA       STB    F,U
B75F: E7 C8 A0    STB    -$60,U
B762: C8 A0       EORB   #$A0
B764: C9 C7       ADCB   #$C7
B766: C9 C7       ADCB   #$C7
B768: C9 C7       ADCB   #$C7
...
B78C: C8 A0       EORB   #$A0
B78E: C8 A0       EORB   #$A0
B790: B8 BF CA    EORA   $BFCA
B793: E7 CA       STB    F,U
B795: E7 C9 C7 C9 STB    -$3837,U
B799: C7 CA       XSTB   #$CA
B79B: E7 C7       STB    E,U
B79D: E1 C9 C7 CA CMPB   -$3836,U
B7A1: E7 CA       STB    F,U
B7A3: E7 C9 C7 C9 STB    -$3837,U
B7A7: C7 C9       XSTB   #$C9
B7A9: C7 C9       XSTB   #$C9
B7AB: C7 C9       XSTB   #$C9
B7AD: C7 C9       XSTB   #$C9
...
B7DA: C2 E6       SBCB   #$E6
B7DC: C2 E6       SBCB   #$E6
B7DE: C3 A2 C2    ADDD   #$A2C2
B7E1: E6 C2       LDB    ,-U
B7E3: E6 C2       LDB    ,-U
B7E5: E6 C2       LDB    ,-U
B7E7: E6 C2       LDB    ,-U
B7E9: E6 C5       LDB    B,U
B7EB: B2 C7 38    SBCA   $C738
B7EE: C5 B2       BITB   #$B2
B7F0: C7 68       XSTB   #$68
B7F2: C2 E6       SBCB   #$E6
B7F4: C2 E6       SBCB   #$E6
B7F6: C5 B2       BITB   #$B2
B7F8: C5 B2       BITB   #$B2
B7FA: B8 BF C3    EORA   $BFC3
B7FD: A6 C3       LDA    ,--U
B7FF: A6 C2       LDA    ,-U
B801: E6 C2       LDB    ,-U
B803: E6 C3       LDB    ,--U
B805: A6 C5       LDA    B,U
B807: B2 C2 E6    SBCA   $C2E6
B80A: C3 A6 C3    ADDD   #$A6C3
B80D: A6 C2       LDA    ,-U
B80F: E6 C2       LDB    ,-U
B811: E6 C2       LDB    ,-U
B813: E6 C2       LDB    ,-U
...
B81F: E6 C2       LDB    ,-U
B821: E6 C2       LDB    ,-U
B823: E6 CC 2C    LDB    $B852,PCR
B826: CC 2C CC    LDD    #$2CCC
B829: 2C CC       BGE    $B7F7
B82B: 2C CC       BGE    $B7F9
B82D: 2C CC       BGE    $B7FB
B82F: 2C D1       BGE    $B802
B831: 05 D1       LSR    $D1
B833: 05 CD       LSR    $CD
B835: 73 CD 73    COM    $CD73
B838: CE 39 CF    LDU    #$39CF
B83B: 6D CD 73 CE TST    $12C0D,PCR
B83F: EC D0       LDD    [,W++]
B841: 30 CC 2C    LEAX   $B870,PCR
B844: CC 2C CD    LDD    #$2CCD
B847: 73 D0 8D    COM    $D08D
B84A: CC 2C CC    LDD    #$2CCC
B84D: 2C D0       BGE    $B81F
B84F: C5 CC       BITB   #$CC
B851: 2C CC       BGE    $B81F
B853: 2C D2       BGE    $B827
...
B861: 05 D1       LSR    $D1
B863: 05 B8       LSR    $B8
B865: BF CD 73    STX    $CD73
B868: CD          XHCF
B869: 73 CC 2C    COM    $CC2C
B86C: CC 2C D1    LDD    #$2CD1
B86F: 05 D1       LSR    $D1
B871: 05 CC       LSR    $CC
B873: 2C CD       BGE    $B842
B875: 73 CD 73    COM    $CD73
B878: CC 2C D1    LDD    #$2CD1
B87B: 33 CC 2C    LEAU   $B8AA,PCR
B87E: CC 2C CC    LDD    #$2CCC
B881: 2C CC       BGE    $B84F
B883: 2C CC       BGE    $B851
B885: 2C CC       BGE    $B853
B887: 2C CC       BGE    $B855
...
B8B3: EE C6       LDU    A,U
B8B5: 6E D5       JMP    [B,U]
B8B7: B8 D3 B9    EORA   $D3B9
B8BA: 3D          MUL
B8BB: B9 A7 BA    ADCA   $A7BA
B8BE: 11 CE B8 B7 LDU    #$B8B7
B8C2: A6 84       LDA    ,X
B8C4: 80 20       SUBA   #$20
B8C6: 84 7C       ANDA   #$7C
B8C8: 44          LSRA
...
B8E2: AC C1       CMPX   ,U++
B8E4: AC C1       CMPX   ,U++
B8E6: AC BF 82 C0 CMPX   [$82C0]
B8EA: A5 C1       BITA   ,U++
B8EC: 42          XNCA
B8ED: B5 AE B5    BITA   $AEB5
B8F0: AE BE       LDX    [W,Y]
B8F2: 6A BE       DEC    [W,Y]
B8F4: 6A C1       DEC    ,U++
B8F6: AC B5       CMPX   [B,Y]
...
B900: 6A BE       DEC    [W,Y]
B902: 6A C2       DEC    ,-U
B904: 71 C2 71    NEG    $C271
B907: C2 71       SBCB   #$71
B909: C2 71       SBCB   #$71
B90B: BE 6A BA    LDX    $6ABA
B90E: 7B BE 6A    XDEC   $BE6A
B911: BE 6A B5    LDX    $6AB5
B914: AE BE       LDX    [W,Y]
B916: 6A BE       DEC    [W,Y]
B918: 6A BE       DEC    [W,Y]
B91A: 6A BE       DEC    [W,Y]
...
B93C: AE C7       LDX    E,U
B93E: DA C9       ORB    $C9
B940: 68 C9 68 C9 ASL    $68C9,U
B944: 68 C9 68 C9 ASL    $68C9,U
B948: 68 CA       ASL    F,U
B94A: C5 CA       BITB   #$CA
B94C: C5 C8       BITB   #$C8
B94E: 8F C8 8F    XSTX   #$C88F
B951: C9 68       ADCB   #$68
B953: C9 68       ADCB   #$68
B955: C9 68       ADCB   #$68
B957: C9 68       ADCB   #$68
...
B979: C8 8F       EORB   #$8F
B97B: C8 8F       EORB   #$8F
B97D: B5 AE CA    BITA   $AECA
B980: C5 CA       BITB   #$CA
B982: C5 C9       BITB   #$C9
B984: 68 C9 68 CA ASL    $68CA,U
B988: C5 C9       BITB   #$C9
B98A: 68 C9 68 CA ASL    $68CA,U
B98E: C5 CA       BITB   #$CA
B990: C5 C9       BITB   #$C9
B992: 68 C9 68 B5 ASL    $68B5,U
B996: AE B5       LDX    [B,Y]
B998: AE B5       LDX    [B,Y]
B99A: AE B5       LDX    [B,Y]
B99C: AE B5       LDX    [B,Y]
...
B9BC: D6 C2       LDB    $C2
B9BE: C6 C4       LDB    #$C4
B9C0: CC C2 C6    LDD    #$C2C6
B9C3: C2 C6       SBCB   #$C6
B9C5: C2 C6       SBCB   #$C6
B9C7: C2 C6       SBCB   #$C6
B9C9: C3 A3 C3    ADDD   #$A3C3
B9CC: 9B C2       ADDA   $C2
B9CE: C6 C2       LDB    #$C2
B9D0: C6 C2       LDB    #$C2
B9D2: C6 C2       LDB    #$C2
...
BA23: CD          XHCF
BA24: 58          ASLB
BA25: CE 12 CF    LDU    #$12CF
BA28: 4A          DECA
BA29: CD          XHCF
BA2A: 58          ASLB
BA2B: B5 AE B5    BITA   $AEB5
BA2E: AE CB       LDX    D,U
BA30: FB CB FB    ADDB   $CBFB
BA33: CD          XHCF
BA34: 58          ASLB
BA35: B5 AE CB    BITA   $AECB
BA38: FB CB FB    ADDB   $CBFB
BA3B: B5 AE CB    BITA   $AECB
BA3E: FB CB FB    ADDB   $CBFB
BA41: D1 E7       CMPB   $E7
BA43: D1 E7       CMPB   $E7
BA45: D1 E7       CMPB   $E7
BA47: D1 E7       CMPB   $E7
BA49: B5 AE BA    BITA   $AEBA
BA4C: 7B D0 DB    XDEC   $D0DB
BA4F: D0 DB       SUBB   $DB
BA51: B5 AE CD    BITA   $AECD
BA54: 58          ASLB
BA55: CD          XHCF
BA56: 58          ASLB
BA57: CB FB       ADDB   #$FB
...
BAC7: ED 1A       STD    -$6,X
BAC9: 10 A3 E4    CMPD   ,S
BACC: 2F D3       BLE    $BAA1
BACE: EC E1       LDD    ,S++
BAD0: ED 1A       STD    -$6,X
BAD2: 5F          CLRB
BAD3: 35 82       PULS   A,PC
BAD5: 0A 30       DEC    $30
BAD7: 0A 36       DEC    $36
BAD9: 0A 32       DEC    $32
BADB: 0A 38       DEC    $38
...
BB60: ED 1A       STD    -$6,X
BB62: 10 A3 E4    CMPD   ,S
BB65: 2C D3       BGE    $BB3A
BB67: EC E1       LDD    ,S++
BB69: ED 1A       STD    -$6,X
BB6B: 5F          CLRB
BB6C: 35 82       PULS   A,PC
BB6E: 8D 20       BSR    $BB90
...
BE8B: 60 14       NEG    -$C,X
BE8D: 60 EC 40    NEG    $BED0,PCR
BE90: 18          X18
BE91: 40          NEGA
BE92: E8 30       EORB   -$10,Y
BE94: 1C 30       ANDCC  #$30
BE96: E4 20       ANDB   $0,Y
BE98: 20 20       BRA    $BEBA
BE9A: E0 BD BA 8D SUBB   [$792B,PCR]
BE9E: 27 01       BEQ    $BEA1
BEA0: 39          RTS
...
BF39: 27 01       BEQ    $BF3C
BF3B: 39          RTS
BF3C: CE BF 44    LDU    #$BF44
BF3F: A6 09       LDA    $9,X
BF41: 48          ASLA
BF42: 6E D6       JMP    [A,U]
BF44: BF 4A BF    STX    $4ABF
BF47: 52          XNCB
BF48: BF 58 A6    STX    $58A6
BF4B: 01 88       NEG    $88
BF4D: 03 A7       COM    $A7
BF4F: 01 A7       NEG    $A7
BF51: 07 CE       ASR    $CE
...
BFA7: 4F          CLRA
BFA8: 39          RTS
BFA9: CE BF B1    LDU    #$BFB1
BFAC: A6 09       LDA    $9,X
BFAE: 48          ASLA
BFAF: 6E D6       JMP    [A,U]
BFB1: BF BB BF    STX    $BBBF
BFB4: D7 BF       STB    $BF
BFB6: EB C0       ADDB   ,U+
BFB8: 21 C0       BRN    $BF7A
BFBA: 2D BD       BLT    $BF79
BFBC: BB D1 A6    ADDA   $D1A6
BFBF: 0C 84       INC    $84
BFC1: 10 26 0B 6A LBNE   $CB2F
BFC5: 0A 27       DEC    $27
BFC7: 01 39       NEG    $39
...
C38F: C3 20 C3    ADDD   #$20C3
C392: 31 C3       LEAY   ,--U
C394: 42          XNCA
C395: C3 53 C3    ADDD   #$53C3
C398: 64 C3       LSR    ,--U
C39A: 75 E6 01    LSR    $E601
C39D: C8 03       EORB   #$03
C39F: 7E B8 8E    JMP    $B88E
C3A2: 39          RTS
C3A3: 7E B5 AE    JMP    $B5AE
C3A6: CE C3 AE    LDU    #$C3AE
C3A9: A6 09       LDA    $9,X
C3AB: 48          ASLA
C3AC: 6E D6       JMP    [A,U]
C3AE: C3 B6 C3    ADDD   #$B6C3
C3B1: B6 C3 C1    LDA    $C3C1
C3B4: C3 CC 6A    ADDD   #$CC6A
C3B7: 0A 27       DEC    $27
C3B9: 01 39       NEG    $39
...
C4F7: 00 30       NEG    $30
C4F9: FF FC 03    STU    $FC03
C4FC: FF D0 00    STU    $D000
C4FF: 04 05       LSR    $05
...
C6EC: 50          NEGB
C6ED: 01 50       NEG    $50
C6EF: FF F0 28    STU    $F028
C6F2: 6E 00       JMP    $0,X
C6F4: 01 80       NEG    $80
C6F6: FF 80 00    STU    $8000
C6F9: D0 FF       SUBB   $FF
C6FB: E0 28       SUBB   $8,Y
C6FD: 6D 00       TST    $0,X
C6FF: 00 80       NEG    $80
...
C726: 6E 00       JMP    $0,X
C728: 01 80       NEG    $80
C72A: FF 30 00    STU    $3000
C72D: 00 FF       NEG    $FF
C72F: F0 FE 10    SUBB   $FE10
C732: 00 70       NEG    $70
C734: FF E0 00    STU    $E000
C737: 00 6A       NEG    $6A
C739: 0A 27       DEC    $27
C73B: 01 39       NEG    $39
C73D: CE C7 45    LDU    #$C745
C740: A6 09       LDA    $9,X
C742: 48          ASLA
C743: 6E D6       JMP    [A,U]
C745: C7 4D       XSTB   #$4D
...
C99F: 00 28       NEG    $28
C9A1: FF F8 23    STU    $F823
C9A4: FF D8 00    STU    $D800
C9A7: 08 23       ASL    $23
C9A9: 00 30       NEG    $30
C9AB: FF F8 17    STU    $F817
C9AE: FF D0 00    STU    $D000
C9B1: 08 17       ASL    $17
C9B3: 00 38       NEG    $38
C9B5: FF F8 0D    STU    $F80D
C9B8: FF C8 00    STU    $C800
C9BB: 08 0D       ASL    $0D
C9BD: 00 40       NEG    $40
C9BF: FF F8 07    STU    $F807
C9C2: FF C0 00    STU    $C000
C9C5: 08 07       ASL    $07
...
CC1C: 60 14       NEG    -$C,X
CC1E: 60 EC 40    NEG    $CC61,PCR
CC21: 18          X18
CC22: 40          NEGA
CC23: E8 30       EORB   -$10,Y
CC25: 1C 30       ANDCC  #$30
CC27: E4 20       ANDB   $0,Y
CC29: 20 20       BRA    $CC4B
CC2B: E0 BD BA 8D SUBB   [$86BC,PCR]
CC2F: 27 01       BEQ    $CC32
CC31: 39          RTS
...
CDE7: CD          XHCF
CDE8: 7B CD 7B    XDEC   $CD7B
CDEB: CD          XHCF
CDEC: 86 CD       LDA    #$CD
CDEE: 9E CD       LDX    $CD
CDF0: C0 CD       SUBB   #$CD
CDF2: 7B CD 7B    XDEC   $CD7B
CDF5: CD          XHCF
CDF6: D2 CC       SBCB   $CC
CDF8: 00 30       NEG    $30
CDFA: ED 18       STD    -$8,X
...
CE37: 4F          CLRA
CE38: 39          RTS
CE39: CE CE 41    LDU    #$CE41
CE3C: A6 09       LDA    $9,X
CE3E: 48          ASLA
CE3F: 6E D6       JMP    [A,U]
CE41: CE 71 CE    LDU    #$71CE
CE44: 71 CE 71    NEG    $CE71
CE47: CE 71 CE    LDU    #$71CE
CE4A: 71 CE 71    NEG    $CE71
CE4D: CE 71 CE    LDU    #$71CE
CE50: 71 CE 71    NEG    $CE71
CE53: CE 7C CE    LDU    #$7CCE
CE56: 9E CE       LDX    $CE
CE58: 71 CE 71    NEG    $CE71
CE5B: CE BD CE    LDU    #$BDCE
CE5E: 71 CE 71    NEG    $CE71
CE61: CE 71 CE    LDU    #$71CE
CE64: 71 CE 71    NEG    $CE71
CE67: CE 71 CE    LDU    #$71CE
CE6A: 71 CE 71    NEG    $CE71
CE6D: CE 71 CE    LDU    #$71CE
CE70: C9 6A       ADCB   #$6A
CE72: 0A 27       DEC    $27
CE74: 01 39       NEG    $39
...
CF2E: CE F4 CE    LDU    #$F4CE
CF31: F4 CE FF    ANDB   $CEFF
CF34: CE F4 CE    LDU    #$F4CE
CF37: F4 CE F4    ANDB   $CEF4
CF3A: CE F4 CE    LDU    #$F4CE
CF3D: F4 CE F4    ANDB   $CEF4
CF40: CE F4 CE    LDU    #$F4CE
CF43: F4 CE F4    ANDB   $CEF4
CF46: CE F4 CF    LDU    #$F4CF
CF49: 0B CE       XDEC   $CE
CF4B: 53          COMB
CF4C: E0 CC 00    SUBB   $CF4F,PCR
CF4F: 03 BD       COM    $BD
CF51: BB 6E C4    ADDA   $6EC4
CF54: 10 27 0E CC LBEQ   $DE24
CF58: 00 40       NEG    $40
CF5A: ED 18       STD    -$8,X
CF5C: A6 0C       LDA    $C,X
CF5E: 84 FD       ANDA   #$FD
...
CF6B: 4F          CLRA
CF6C: 39          RTS
CF6D: CE CF 75    LDU    #$CF75
CF70: A6 09       LDA    $9,X
CF72: 48          ASLA
CF73: 6E D6       JMP    [A,U]
CF75: CF 99 CF    XSTU   #$99CF
CF78: 99 CF       ADCA   $CF
CF7A: 99 CF       ADCA   $CF
CF7C: 99 CF       ADCA   $CF
CF7E: A4 CF       ANDA   ,W++
...
D7E2: 00 00       NEG    $00
D7E4: 00 00       NEG    $00
D7E6: 78 14 78    ASL    $1478
D7E9: 8E 78 94    LDX    #$7894
D7EC: 78 14 78    ASL    $1478
D7EF: 40          NEGA
D7F0: 78 40 78    ASL    $4078
D7F3: 40          NEGA
D7F4: 78 40 78    ASL    $4078
D7F7: 9A 78       ORA    $78
D7F9: AF 78       STX    -$8,S
D7FB: C4 79       ANDB   #$79
D7FD: 01 79       NEG    $79
D7FF: 39          RTS
D800: 79 58 79    ROL    $5879
D803: 63 79       COM    -$7,S
D805: AA 79       ORA    -$7,S
D807: B5 79 ED    BITA   $79ED
D80A: 79 F3 7A    ROL    $F37A
D80D: 26 7A       BNE    $D889
D80F: 5E          XCLRB
D810: 7A 73 7A    DEC    $737A
D813: 92 7A       SBCA   $7A
D815: CF 80 94    XSTU   #$8094
D818: 96 80       LDA    $80
D81A: 80 94       SUBA   #$94
D81C: 96 80       LDA    $80
D81E: 82 8E       SBCA   #$8E
D820: 8E 82 84    LDX    #$8284
D823: 84 84       ANDA   #$84
D825: 84 60       ANDA   #$60
D827: 62 60       XNC    $0,S
D829: 60 62       NEG    $2,S
...
D8EC: ED 0E       STD    $E,X
D8EE: 39          RTS
D8EF: 78 14 78    ASL    $1478
D8F2: 1F 78       TFR    inv,A
D8F4: 2A 78       BPL    $D96E
D8F6: 35 CE       PULS   D,DP,U,PC
D8F8: D8 FF       EORB   $FF
D8FA: A6 02       LDA    $2,X
D8FC: 48          ASLA
D8FD: 6E D6       JMP    [A,U]
...
D9F6: 0C 45       INC    $45
D9F8: 39          RTS
D9F9: 78 40 78    ASL    $4078
D9FC: 46          RORA
D9FD: 78 4C 78    ASL    $4C78
DA00: 52          XNCB
DA01: 78 58 78    ASL    $5878
DA04: 5E          XCLRB
DA05: 78 64 78    ASL    $6478
DA08: 6A 78       DEC    -$8,S
DA0A: 70 78 76    NEG    $7876
DA0D: 78 7C 78    ASL    $7C78
DA10: 82 78       SBCA   #$78
DA12: 88 39       EORA   #$39
DA14: 39          RTS
DA15: 39          RTS
...
DD6D: ED 4C       STD    $C,U
DD6F: 39          RTS
DD70: 7C 14 7C    INC    $147C
DD73: 18          X18
DD74: 7C 1C 7C    INC    $1C7C
DD77: 14          XHCF
DD78: 7C 18 7C    INC    $187C
DD7B: 1C 7C       ANDCC  #$7C
DD7D: 14          XHCF
DD7E: 7C 18 7C    INC    $187C
DD81: 1C 7C       ANDCC  #$7C
DD83: 14          XHCF
DD84: 7C 18 7C    INC    $187C
DD87: 1C 7C       ANDCC  #$7C
DD89: 14          XHCF
DD8A: 7C 18 7C    INC    $187C
DD8D: 1C CE       ANDCC  #$CE
DD8F: 44          LSRA
DD90: 10 A6 C4    LDA    ,U
DD93: 2A 01       BPL    $DD96
...
DE85: 39          RTS
DE86: 06 28       ROR    $28
DE88: 74 00 06    LSR    >$0006
DE8B: 28 74       BVC    $DF01
DE8D: 46          RORA
DE8E: 06 28       ROR    $28
DE90: 74 59 06    LSR    $5906
DE93: 28 74       BVC    $DF09
DE95: 6C 06       INC    $6,X
DE97: 28 74       BVC    $DF0D
DE99: 13          SYNC
DE9A: 06 28       ROR    $28
DE9C: 74 26 06    LSR    $2606
DE9F: 28 74       BVC    $DF15
DEA1: 39          RTS
DEA2: 0A 2B       DEC    $2B
DEA4: 74 8C 06    LSR    $8C06
DEA7: 29 74       BVS    $DF1D
DEA9: 79 06 2A    ROL    $062A
DEAC: 74 B2 06    LSR    $B206
DEAF: 29 74       BVS    $DF25
DEB1: 79 06 28    ROL    $0628
DEB4: 74 9F 06    LSR    $9F06
DEB7: 29 74       BVS    $DF2D
DEB9: 79 06 2A    ROL    $062A
DEBC: 74 B2 04    LSR    $B204
DEBF: 29 74       BVS    $DF35
DEC1: 79 0A 2B    ROL    $0A2B
DEC4: 74 8C 06    LSR    $8C06
DEC7: 28 74       BVC    $DF3D
DEC9: 9F 06       STX    $06
DECB: 29 74       BVS    $DF41
DECD: 79 0A 2B    ROL    $0A2B
DED0: 74 8C 06    LSR    $8C06
DED3: 28 74       BVC    $DF49
DED5: 9F 06       STX    $06
DED7: 29 74       BVS    $DF4D
DED9: 79 06 2B    ROL    $062B
DEDC: 74 8C 06    LSR    $8C06
DEDF: 28 74       BVC    $DF55
DEE1: 9F 06       STX    $06
DEE3: 28 74       BVC    $DF59
DEE5: 00 06       NEG    $06
DEE7: F4 74 C5    ANDB   $74C5
DEEA: 06 F4       ROR    $F4
DEEC: 74 D8 06    LSR    $D806
DEEF: F4 74 F1    ANDB   $74F1
DEF2: 06 F4       ROR    $F4
DEF4: 74 FE 06    LSR    $FE06
DEF7: F4 75 11    ANDB   $7511
DEFA: 06 F4       ROR    $F4
DEFC: 75 24 06    LSR    $2406
DEFF: F4 75 3D    ANDB   $753D
DF02: 06 F4       ROR    $F4
DF04: 75 4A 08    LSR    $4A08
DF07: 28 75       BVC    $DF7E
DF09: 5D          TSTB
DF0A: 0A 78       DEC    $78
DF0C: 75 70 08    LSR    $7008
DF0F: 78 75 83    ASL    $7583
DF12: 08 28       ASL    $28
DF14: 75 5D 0A    LSR    $5D0A
DF17: 78 75 70    ASL    $7570
DF1A: 08 28       ASL    $28
DF1C: 75 5D 08    LSR    $5D08
DF1F: 78 75 83    ASL    $7583
DF22: 06 3C       ROR    $3C
DF24: 75 A3 06    LSR    $A306
DF27: 3C 75       CWAI   #$75
DF29: B0 06 3C    SUBA   $063C
DF2C: 75 BD 06    LSR    $BD06
DF2F: 3C 75       CWAI   #$75
DF31: CA 06       ORB    #$06
DF33: 3C 75       CWAI   #$75
DF35: D7 06       STB    $06
...
DF39: E4 06       ANDB   $6,X
DF3B: 3C 75       CWAI   #$75
DF3D: BD 06 3C    JSR    $063C
DF40: 75 96 06    LSR    $9606
DF43: 3C 75       CWAI   #$75
DF45: E4 06       ANDB   $6,X
DF47: 3C 75       CWAI   #$75
DF49: 96 06       LDA    $06
DF4B: 3C 75       CWAI   #$75
DF4D: F1 06 47    CMPB   $0647
DF50: 75 FE 06    LSR    $FE06
DF53: 3F          SWI
DF54: 76 0B 06    ROR    $0B06
DF57: 3F          SWI
DF58: 76 18 06    ROR    $1806
DF5B: 3F          SWI
DF5C: 76 0B 06    ROR    $0B06
DF5F: 47          ASRA
DF60: 75 FE 06    LSR    $FE06
DF63: 3C 75       CWAI   #$75
DF65: F1 06 3F    CMPB   $063F
DF68: 76 25 06    ROR    $2506
DF6B: 3F          SWI
DF6C: 76 2C 06    ROR    $2C06
DF6F: 3F          SWI
DF70: 76 33 06    ROR    $3306
DF73: 3E          XRES
DF74: 76 3A 06    ROR    $3A06
DF77: 3D          MUL
DF78: 76 47 06    ROR    $4706
DF7B: 3C 75       CWAI   #$75
DF7D: F1 06 47    CMPB   $0647
DF80: 75 FE 06    LSR    $FE06
DF83: 3F          SWI
DF84: 76 0B 06    ROR    $0B06
DF87: 3F          SWI
DF88: 76 18 06    ROR    $1806
DF8B: 3F          SWI
DF8C: 76 25 06    ROR    $2506
DF8F: 3F          SWI
DF90: 76 2C 06    ROR    $2C06
DF93: 3F          SWI
DF94: 76 33 06    ROR    $3306
DF97: 3E          XRES
DF98: 76 3A 06    ROR    $3A06
DF9B: 3D          MUL
DF9C: 76 47 01    ROR    $4701
DF9F: 3C 76       CWAI   #$76
DFA1: 54          LSRB
DFA2: 06 41       ROR    $41
DFA4: 76 61 06    ROR    $6106
DFA7: 41          NEGA
DFA8: 76 6E 06    ROR    $6E06
DFAB: 41          NEGA
DFAC: 76 7B 06    ROR    $7B06
DFAF: 41          NEGA
DFB0: 76 6E 06    ROR    $6E06
DFB3: 41          NEGA
DFB4: 76 61 06    ROR    $6106
DFB7: 3C 76       CWAI   #$76
DFB9: 54          LSRB
DFBA: 06 3C       ROR    $3C
DFBC: 76 88 06    ROR    $8806
DFBF: 3C 76       CWAI   #$76
DFC1: 95 06       BITA   $06
DFC3: 51          NEGB
DFC4: 76 A2 06    ROR    $A206
DFC7: 51          NEGB
DFC8: 76 AF 06    ROR    $AF06
DFCB: 42          XNCA
DFCC: 76 BC 06    ROR    $BC06
DFCF: 42          XNCA
DFD0: 76 C9 06    ROR    $C906
DFD3: 43          COMA
DFD4: 76 D6 06    ROR    $D606
DFD7: 4B          XDECA
DFD8: 76 E3 06    ROR    $E306
DFDB: 4B          XDECA
DFDC: 76 F0 06    ROR    $F006
DFDF: 4C          INCA
DFE0: 76 FD 06    ROR    $FD06
DFE3: 52          XNCB
DFE4: 77 0A 06    ASR    $0A06
DFE7: 4E          XCLRA
DFE8: 77 17 06    ASR    $1706
DFEB: 4E          XCLRA
DFEC: 77 1E 06    ASR    $1E06
DFEF: 4F          CLRA
DFF0: 77 25 06    ASR    $2506
DFF3: 4B          XDECA
DFF4: 77 32 06    ASR    $3206
DFF7: 4D          TSTA
DFF8: 77 3F 06    ASR    $3F06
DFFB: 45          LSRA
DFFC: 77 46 06    ASR    $4606
DFFF: 46          RORA
E000: 77 4D 06    ASR    $4D06
E003: 46          RORA
E004: 77 5A 06    ASR    $5A06
E007: 44          LSRA
E008: 77 67 06    ASR    $6706
E00B: 44          LSRA
E00C: 77 74 06    ASR    $7406
E00F: 44          LSRA
E010: 77 81 06    ASR    $8106
E013: 3C 77       CWAI   #$77
E015: 8E 06 3C    LDX    #$063C
E018: 77 9B 06    ASR    $9B06
E01B: 3C 75       CWAI   #$75
E01D: F1 06 40    CMPB   $0640
E020: 77 A8 06    ASR    $A806
E023: 40          NEGA
E024: 77 B5 06    ASR    $B506
E027: 43          COMA
E028: 77 C2 06    ASR    $C206
E02B: 3C 77       CWAI   #$77
E02D: C9 06       ADCB   #$06
E02F: 48          ASLA
E030: 77 F1 06    ASR    $F106
E033: 3C 77       CWAI   #$77
E035: D6 06       LDB    $06
E037: 27 77       BEQ    $E0B0
E039: DD 06       STD    $06
E03B: 43          COMA
E03C: 77 EA 06    ASR    $EA06
E03F: 48          ASLA
E040: 77 F1 06    ASR    $F106
E043: 48          ASLA
E044: 77 F8 06    ASR    $F806
E047: 42          XNCA
E048: 78 05 06    ASL    $0506
E04B: 47          ASRA
E04C: 78 0C 06    ASL    $0C06
E04F: 47          ASRA
E050: 78 19 06    ASL    $1906
E053: 49          ROLA
E054: 78 26 06    ASL    $2606
E057: 49          ROLA
E058: 78 33 06    ASL    $3306
E05B: 49          ROLA
E05C: 78 40 06    ASL    $4006
E05F: 3C 78       CWAI   #$78
E061: 4D          TSTA
E062: 06 3C       ROR    $3C
E064: 76 54 06    ROR    $5406
E067: 3C 78       CWAI   #$78
E069: 5A          DECB
E06A: 06 4A       ROR    $4A
E06C: 78 67 06    ASL    $6706
E06F: 7F 78 74    CLR    $7874
E072: 06 4A       ROR    $4A
E074: 78 81 06    ASL    $8106
E077: 4A          DECA
E078: 78 81 06    ASL    $8106
E07B: 41          NEGA
E07C: 76 61 06    ROR    $6106
E07F: 3C 76       CWAI   #$76
E081: 54          LSRB
E082: 06 3C       ROR    $3C
E084: 75 F1 06    LSR    $F106
E087: 40          NEGA
E088: 77 A8 06    ASR    $A806
E08B: 40          NEGA
E08C: 77 B5 06    ASR    $B506
E08F: 43          COMA
E090: 77 C2 06    ASR    $C206
E093: 3C 77       CWAI   #$77
E095: C9 06       ADCB   #$06
E097: 48          ASLA
E098: 77 F1 06    ASR    $F106
E09B: 3C 77       CWAI   #$77
E09D: D6 06       LDB    $06
E09F: 43          COMA
E0A0: 77 EA 06    ASR    $EA06
E0A3: 48          ASLA
E0A4: 77 F1 06    ASR    $F106
E0A7: 48          ASLA
E0A8: 77 F8 06    ASR    $F806
E0AB: 42          XNCA
E0AC: 78 05 06    ASL    $0506
E0AF: 47          ASRA
E0B0: 78 0C 06    ASL    $0C06
E0B3: 47          ASRA
E0B4: 78 19 06    ASL    $1906
E0B7: 49          ROLA
E0B8: 78 26 06    ASL    $2606
E0BB: 49          ROLA
E0BC: 78 33 06    ASL    $3306
E0BF: 49          ROLA
E0C0: 78 40 06    ASL    $4006
E0C3: 3C 78       CWAI   #$78
E0C5: 4D          TSTA
E0C6: 06 BC       ROR    $BC
E0C8: 78 8E 06    ASL    $8E06
E0CB: BC 78 9B    CMPX   $789B
E0CE: 06 C1       ROR    $C1
E0D0: 78 A8 06    ASL    $A806
E0D3: C1 78       CMPB   #$78
E0D5: B5 06 C1    BITA   $06C1
E0D8: 78 CF 06    ASL    $CF06
E0DB: CB 78       ADDB   #$78
E0DD: DC 06       LDD    $06
E0DF: F3 78 E9    ADDD   $78E9
E0E2: 06 C1       ROR    $C1
E0E4: 78 C2 06    ASL    $C206
E0E7: BC 78 9B    CMPX   $789B
E0EA: 06 C1       ROR    $C1
E0EC: 78 A8 06    ASL    $A806
E0EF: C1 78       CMPB   #$78
E0F1: B5 06 C1    BITA   $06C1
E0F4: 78 CF 06    ASL    $CF06
E0F7: CB 78       ADDB   #$78
E0F9: DC 06       LDD    $06
E0FB: F3 78 E9    ADDD   $78E9
E0FE: 06 32       ROR    $32
E100: 72 2E 06    XNC    $2E06
E103: 32 72       LEAS   -$E,S
E105: 3B          RTI
E106: 06 32       ROR    $32
E108: 72 4E 06    XNC    $4E06
E10B: 32 72       LEAS   -$E,S
E10D: 5B          XDECB
E10E: 06 32       ROR    $32
E110: 72 68 06    XNC    $6806
E113: 32 72       LEAS   -$E,S
E115: 75 06 35    LSR    $0635
E118: 72 82 06    XNC    $8206
E11B: 33 72       LEAU   -$E,S
E11D: 8F 06 34    XSTX   #$0634
E120: 72 9C 06    XNC    $9C06
E123: 34 72       PSHS   U,Y,X,A
E125: A9 06       ADCA   $6,X
E127: 35 72       PULS   A,X,Y,U
E129: B6 06 35    LDA    $0635
E12C: 72 C3 06    XNC    $C306
E12F: 35 72       PULS   A,X,Y,U
E131: D0 06       SUBB   $06
E133: 32 72       LEAS   -$E,S
E135: DD 06       STD    $06
E137: 32 72       LEAS   -$E,S
E139: EA 06       ORB    $6,X
E13B: 36 72       PSHU   S,Y,X,A
E13D: F7 06 36    STB    $0636
E140: 73 0A 06    COM    $0A06
E143: 38 73       XANDCC #$73
E145: 1D          SEX
E146: 06 38       ROR    $38
E148: 73 2A 03    COM    $2A03
E14B: 37 73       PULU   CC,A,X,Y,S
E14D: 3D          MUL
E14E: 03 37       COM    $37
E150: 73 50 03    COM    $5003
E153: 37 73       PULU   CC,A,X,Y,S
E155: 63 06       COM    $6,X
E157: 38 73       XANDCC #$73
E159: 7C 08 F5    INC    $08F5
E15C: 74 13 08    LSR    $1308
E15F: F5 74 20    BITB   $7420
E162: 08 F5       ASL    $F5
E164: 74 2D 08    LSR    $2D08
E167: F5 74 3A    BITB   $743A
E16A: 06 39       ROR    $39
E16C: 73 95 06    COM    $9506
E16F: 39          RTS
E170: 73 9C 06    COM    $9C06
E173: 39          RTS
E174: 73 A9 06    COM    $A906
E177: 39          RTS
E178: 73 B6 06    COM    $B606
E17B: 39          RTS
E17C: 73 BD 06    COM    $BD06
E17F: 39          RTS
E180: 73 C4 06    COM    $C406
E183: 39          RTS
E184: 73 CB 06    COM    $CB06
E187: 3A          ABX
E188: 73 D8 06    COM    $D806
E18B: 3A          ABX
E18C: 73 E5 06    COM    $E506
E18F: 3B          RTI
E190: 73 F2 06    COM    $F206
E193: 32 73       LEAS   -$D,S
E195: F9 06 32    ADCB   $0632
E198: 74 06 06    LSR    $0606
E19B: 2C 75       BGE    $E212
E19D: 7C 06 2C    INC    $062C
E1A0: 75 62 06    LSR    $6206
E1A3: 2C 75       BGE    $E21A
E1A5: 7C 06 2C    INC    $062C
E1A8: 75 6F 06    LSR    $6F06
E1AB: 2C 75       BGE    $E222
E1AD: 89 06       ADCA   #$06
E1AF: 2C 76       BGE    $E227
E1B1: 0C 06       INC    $06
...
E1BD: E0 06       SUBB   $6,X
E1BF: 30 75       LEAX   -$B,S
E1C1: F9 06 2D    ADCB   $062D
E1C4: 74 E4 06    LSR    $E406
E1C7: 2D 74       BLT    $E23D
E1C9: F7 06 2E    STB    $062E
E1CC: 75 10 06    LSR    $1006
E1CF: 2E 75       BGT    $E246
E1D1: 29 06       BVS    $E1D9
E1D3: 2E 75       BGT    $E24A
E1D5: 3C 06       CWAI   #$06
...
E1D9: 4F          CLRA
E1DA: 06 31       ROR    $31
E1DC: 74 A5 06    LSR    $A506
E1DF: 2D 74       BLT    $E255
E1E1: BE 06 2D    LDX    $062D
E1E4: 74 D1 06    LSR    $D106
E1E7: 2D 74       BLT    $E25D
E1E9: BE 06 AD    LDX    $06AD
E1EC: 74 47 06    LSR    $4706
E1EF: AD 74       JSR    -$C,S
E1F1: 60 06       NEG    $6,X
E1F3: AD 74       JSR    -$C,S
E1F5: 73 06 AD    COM    $06AD
E1F8: 74 8C 06    LSR    $8C06
E1FB: 30 75       LEAX   -$B,S
E1FD: F9 06 30    ADCB   $0630
E200: 75 E0 06    LSR    $E006
E203: 2F 75       BLE    $E27A
E205: C1 06       CMPB   #$06
E207: 30 75       LEAX   -$B,S
E209: E0 06       SUBB   $6,X
E20B: 30 75       LEAX   -$B,S
E20D: F9 00 00    ADCB   >$0000
E210: 03 70       COM    $70
E212: FF A0 FF    STU    $A0FF
E215: A0 00       SUBA   $0,X
E217: D0 00       SUBB   $00
E219: 00 03       NEG    $03
E21B: 70 FF F0    NEG    $FFF0
E21E: FF 50 00    STU    $5000
E221: D0 00       SUBB   $00
E223: 00 03       NEG    $03
E225: 70 00 30    NEG    >$0030
E228: FF 10 00    STU    $1000
E22B: D0 00       SUBB   $00
E22D: 00 03       NEG    $03
E22F: 70 FF 70    NEG    $FF70
E232: FF D0 00    STU    $D000
E235: D0 00       SUBB   $00
E237: 00 02       NEG    $02
E239: E0 FF 70 FF SUBB   [$70FF]
E23D: D0 00       SUBB   $00
E23F: D0 00       SUBB   $00
E241: 60 02       NEG    $2,X
E243: E0 FF B0 FF SUBB   [$B0FF]
E247: 90 00       SUBA   $00
E249: D0 00       SUBB   $00
E24B: 00 02       NEG    $02
E24D: E0 FF C0 FF SUBB   [$C0FF]
E251: 80 00       SUBA   #$00
E253: D0 01       SUBB   $01
E255: 20 01       BRA    $E258
E257: E0 00       SUBB   $0,X
...
E25E: 01 A0       NEG    $A0
E260: 01 A0       NEG    $A0
E262: FF B0 FF    STU    $B0FF
E265: 90 00       SUBA   $00
E267: D0 02       SUBB   $02
E269: 30 01       LEAX   $1,X
E26B: A0 FF B0 FF SUBA   [$B0FF]
E26F: 90 00       SUBA   $00
E271: D0 01       SUBB   $01
E273: D0 01       SUBB   $01
E275: A0 FF 40 00 SUBA   [$4000]
E279: 00 00       NEG    $00
E27B: D0 01       SUBB   $01
E27D: C0 01       SUBB   #$01
E27F: A0 FF 70 FF SUBA   [$70FF]
E283: D0 00       SUBB   $00
E285: D0 00       SUBB   $00
E287: 00 03       NEG    $03
E289: 20 FF       BRA    $E28A
...
E293: 00 FF       NEG    $FF
E295: D0 FF       SUBB   $FF
E297: 70 00 D0    NEG    >$00D0
E29A: 00 00       NEG    $00
E29C: 03 20       COM    $20
E29E: FF 60 FF    STU    $60FF
E2A1: E0 00       SUBB   $0,X
E2A3: D0 00       SUBB   $00
E2A5: 00 02       NEG    $02
E2A7: 60 FF 50 FF NEG    [$50FF]
E2AB: F0 00 D0    SUBB   >$00D0
E2AE: 00 00       NEG    $00
E2B0: 03 70       COM    $70
E2B2: FF 40 00    STU    $4000
E2B5: 00 00       NEG    $00
E2B7: D0 00       SUBB   $00
E2B9: 00 02       NEG    $02
E2BB: 60 FF C0 FF NEG    [$C0FF]
E2BF: 80 00       SUBA   #$00
E2C1: D0 00       SUBB   $00
E2C3: 00 02       NEG    $02
E2C5: 60 FF 70 FF NEG    [$70FF]
E2C9: D0 00       SUBB   $00
E2CB: D0 00       SUBB   $00
E2CD: 50          NEGB
E2CE: 02 E0       XNC    $E0
E2D0: FF E0 FF    STU    $E0FF
E2D3: 60 00       NEG    $0,X
E2D5: D0 00       SUBB   $00
E2D7: 00 02       NEG    $02
E2D9: A0 FF 70 FF SUBA   [$70FF]
E2DD: D0 00       SUBB   $00
E2DF: D0 00       SUBB   $00
E2E1: 60 02       NEG    $2,X
E2E3: A0 FF A0 FF SUBA   [$A0FF]
E2E7: A0 00       SUBA   $0,X
E2E9: D0 00       SUBB   $00
E2EB: 00 03       NEG    $03
E2ED: 20 FF       BRA    $E2EE
E2EF: F0 FF 50    SUBB   $FF50
E2F2: 00 D0       NEG    $D0
E2F4: FF 40 03    STU    $4003
E2F7: 00 00       NEG    $00
E2F9: 40          NEGA
E2FA: FF 00 00    STU    >$0000
E2FD: D0 00       SUBB   $00
E2FF: 00 03       NEG    $03
E301: 00 00       NEG    $00
E303: 10 FF 30 00 STS    $3000
E307: D0 00       SUBB   $00
E309: 00 03       NEG    $03
E30B: 70 00 00    NEG    >$0000
E30E: FF 40 00    STU    $4000
E311: D0 00       SUBB   $00
E313: 00 03       NEG    $03
E315: 20 FF       BRA    $E316
E317: 80 FF       SUBA   #$FF
...
E31D: 00 02       NEG    $02
E31F: 00 FF       NEG    $FF
E321: 70 FF D0    NEG    $FFD0
E324: 00 D0       NEG    $D0
E326: 01 F0       NEG    $F0
E328: 02 00       XNC    $00
E32A: FF A0 FF    STU    $A0FF
E32D: A0 00       SUBA   $0,X
E32F: D0 01       SUBB   $01
E331: 50          NEGB
E332: 02 00       XNC    $00
E334: FF A0 FF    STU    $A0FF
E337: A0 00       SUBA   $0,X
E339: D0 02       SUBB   $02
E33B: 10 02 00    XNC    $00
E33E: 00 00       NEG    $00
E340: FF 40 00    STU    $4000
E343: D0 02       SUBB   $02
E345: 90 02       SUBA   $02
E347: 00 00       NEG    $00
E349: 00 FF       NEG    $FF
...
E350: 02 00       XNC    $00
E352: 00 20       NEG    $20
E354: FF 20 00    STU    $2000
E357: D0 00       SUBB   $00
E359: 00 03       NEG    $03
E35B: C0 FF       SUBB   #$FF
E35D: B0 FF 90    SUBA   $FF90
E360: 00 D0       NEG    $D0
E362: 00 20       NEG    $20
E364: 03 F0       COM    $F0
E366: FF E0 FF    STU    $E0FF
E369: 60 00       NEG    $0,X
E36B: D0 00       SUBB   $00
E36D: 00 03       NEG    $03
E36F: 70 FF 60    NEG    $FF60
E372: FF E0 00    STU    $E000
E375: D0 00       SUBB   $00
E377: 00 03       NEG    $03
E379: 70 FF B0    NEG    $FFB0
E37C: FF 90 00    STU    $9000
E37F: D0 00       SUBB   $00
E381: 00 03       NEG    $03
E383: 70 FF F0    NEG    $FFF0
E386: FF 50 00    STU    $5000
E389: D0 00       SUBB   $00
E38B: 00 02       NEG    $02
E38D: A0 FF D0 FF SUBA   [$D0FF]
E391: 70 00 D0    NEG    >$00D0
E394: FF 50 03    STU    $5003
E397: 20 FF       BRA    $E398
E399: 90 FF       SUBA   $FF
E39B: 80 01       SUBA   #$01
E39D: 00 00       NEG    $00
E39F: 00 02       NEG    $02
E3A1: 80 FF       SUBA   #$FF
E3A3: B0 FF 60    SUBA   $FF60
E3A6: 01 00       NEG    $00
E3A8: 00 00       NEG    $00
E3AA: 02 D0       XNC    $D0
E3AC: FF A0 FF    STU    $A0FF
E3AF: 70 01 00    NEG    $0100
E3B2: 00 B0       NEG    $B0
E3B4: 02 00       XNC    $00
E3B6: FF C0 FF    STU    $C0FF
E3B9: 50          NEGB
E3BA: 01 00       NEG    $00
E3BC: 00 00       NEG    $00
E3BE: 03 00       COM    $00
E3C0: FF 70 FF    STU    $70FF
E3C3: A0 01       SUBA   $1,X
E3C5: 00 00       NEG    $00
E3C7: 00 03       NEG    $03
E3C9: 00 FF       NEG    $FF
E3CB: 70 FF 80    NEG    $FF80
E3CE: 01 20       NEG    $20
E3D0: 00 00       NEG    $00
E3D2: 02 60       XNC    $60
E3D4: FF A0 FF    STU    $A0FF
E3D7: 50          NEGB
E3D8: 01 20       NEG    $20
E3DA: 00 00       NEG    $00
E3DC: 02 00       XNC    $00
E3DE: FF C0 FF    STU    $C0FF
E3E1: 30 01       LEAX   $1,X
E3E3: 20 00       BRA    $E3E5
E3E5: E0 02       SUBB   $2,X
E3E7: 60 FF 70 FF NEG    [$70FF]
E3EB: 80 01       SUBA   #$01
E3ED: 20 01       BRA    $E3F0
E3EF: 00 02       NEG    $02
E3F1: 00 FF       NEG    $FF
...
E403: 00 02       NEG    $02
E405: 80 FF       SUBA   #$FF
E407: B0 FF 80    SUBA   $FF80
E40A: 00 E0       NEG    $E0
E40C: 00 50       NEG    $50
E40E: 02 A0       XNC    $A0
E410: 00 10       NEG    $10
E412: FF 20 00    STU    $2000
E415: E0 01       SUBB   $1,X
E417: 00 02       NEG    $02
E419: A0 00       SUBA   $0,X
E41B: 10 FF 20 00 STS    $2000
E41F: E0 00       SUBB   $0,X
E421: 00 02       NEG    $02
E423: 40          NEGA
E424: FF E0 FF    STU    $E0FF
E427: 50          NEGB
E428: 00 E0       NEG    $E0
E42A: 00 60       NEG    $60
E42C: 02 20       XNC    $20
E42E: 00 00       NEG    $00
E430: FF 30 00    STU    $3000
E433: E0 00       SUBB   $0,X
E435: 50          NEGB
E436: 02 40       XNC    $40
E438: 00 10       NEG    $10
E43A: FF 20 00    STU    $2000
E43D: E0 00       SUBB   $0,X
E43F: 00 02       NEG    $02
E441: A0 00       SUBA   $0,X
E443: 20 FF       BRA    $E444
E445: 10 00 E0    NEG    $E0
E448: 00 00       NEG    $00
E44A: 01 60       NEG    $60
E44C: FF C0 FF    STU    $C0FF
E44F: B0 00 A0    SUBA   >$00A0
E452: 00 00       NEG    $00
E454: 01 00       NEG    $00
E456: FF 60 FF    STU    $60FF
E459: B0 01 00    SUBA   $0100
E45C: 00 00       NEG    $00
E45E: 01 C0       NEG    $C0
E460: FF C0 FF    STU    $C0FF
E463: B0 00 A0    SUBA   >$00A0
E466: 00 00       NEG    $00
E468: 01 80       NEG    $80
E46A: FF 00 FE    STU    >$00FE
E46D: 30 02       LEAX   $2,X
E46F: E0 00       SUBB   $0,X
E471: 00 01       NEG    $01
E473: 80 FF       SUBA   #$FF
E475: 50          NEGB
E476: FE 40 02    LDU    $4002
E479: 80 00       SUBA   #$00
E47B: 00 01       NEG    $01
E47D: 80 FF       SUBA   #$FF
E47F: 50          NEGB
E480: FE A0 02    LDU    $A002
E483: 20 00       BRA    $E485
E485: 00 01       NEG    $01
E487: 80 FF       SUBA   #$FF
E489: 90 FF       SUBA   $FF
...
E48E: 00 00       NEG    $00
E490: 01 80       NEG    $80
E492: FF 40 FF    STU    $40FF
E495: 90 01       SUBA   $01
E497: 40          NEGA
E498: 00 00       NEG    $00
E49A: 01 00       NEG    $00
E49C: FF 20 FE    STU    $20FE
E49F: 30 02       LEAX   $2,X
E4A1: C0 00       SUBB   #$00
E4A3: 00 01       NEG    $01
E4A5: 80 FF       SUBA   #$FF
E4A7: 80 FF       SUBA   #$FF
E4A9: 10 01 80    NEG    $80
E4AC: 00 00       NEG    $00
E4AE: 01 C0       NEG    $C0
E4B0: FF 80 FF    STU    $80FF
E4B3: 90 01       SUBA   $01
E4B5: 00 00       NEG    $00
E4B7: 00 01       NEG    $01
E4B9: 80 FF       SUBA   #$FF
E4BB: 00 FE       NEG    $FE
E4BD: B0 02 60    SUBA   $0260
E4C0: 00 00       NEG    $00
E4C2: 01 00       NEG    $00
E4C4: FF 00 FF    STU    >$00FF
E4C7: 90 01       SUBA   $01
E4C9: 80 00       SUBA   #$00
E4CB: 00 01       NEG    $01
E4CD: 00 FF       NEG    $FF
E4CF: 00 FF       NEG    $FF
E4D1: 10 02 00    XNC    $00
E4D4: 00 00       NEG    $00
E4D6: 01 80       NEG    $80
E4D8: FF 80 FE    STU    $80FE
E4DB: 90 02       SUBA   $02
E4DD: 00 00       NEG    $00
E4DF: 00 01       NEG    $01
E4E1: 40          NEGA
E4E2: FF 90 FF    STU    $90FF
E4E5: 80 01       SUBA   #$01
E4E7: 00 00       NEG    $00
E4E9: 00 01       NEG    $01
E4EB: 80 FF       SUBA   #$FF
...
E4F1: 20 00       BRA    $E4F3
E4F3: 80 01       SUBA   #$01
E4F5: 60 FF 90 FE NEG    [$90FE]
E4F9: 20 02       BRA    $E4FD
E4FB: 60 00       NEG    $0,X
E4FD: 00 02       NEG    $02
E4FF: 60 FF 10 00 NEG    [$1000]
E503: 00 01       NEG    $01
E505: 00 00       NEG    $00
E507: 00 03       NEG    $03
E509: 20 FF       BRA    $E50A
E50B: 10 00 00    NEG    $00
E50E: 01 00       NEG    $00
E510: 00 00       NEG    $00
E512: 01 80       NEG    $80
E514: FF 00 FF    STU    >$00FF
E517: D0 01       SUBB   $01
E519: 40          NEGA
E51A: 01 D0       NEG    $D0
E51C: 01 40       NEG    $40
E51E: FF 10 00    STU    $1000
E521: 40          NEGA
E522: 00 C0       NEG    $C0
E524: 01 B0       NEG    $B0
E526: 01 C0       NEG    $C0
E528: FF 10 00    STU    $1000
E52B: 40          NEGA
E52C: 00 C0       NEG    $C0
E52E: 01 00       NEG    $00
E530: 01 C0       NEG    $C0
E532: FF 90 FF    STU    $90FF
E535: C0 00       SUBB   #$00
E537: C0 00       SUBB   #$00
E539: 00 01       NEG    $01
E53B: 00 FF       NEG    $FF
E53D: 40          NEGA
E53E: FE D0 02    LDU    $D002
E541: 00 01       NEG    $01
E543: 60 02       NEG    $2,X
E545: 20 FF       BRA    $E546
E547: 10 00 00    NEG    $00
E54A: 01 00       NEG    $00
E54C: 00 00       NEG    $00
E54E: 03 70       COM    $70
E550: FF 90 FF    STU    $90FF
E553: B0 00 D0    SUBA   >$00D0
E556: 00 00       NEG    $00
E558: 03 70       COM    $70
E55A: FF 40 00    STU    $4000
E55D: 00 00       NEG    $00
E55F: D0 00       SUBB   $00
E561: 00 03       NEG    $03
E563: 70 FE F0    NEG    $FEF0
E566: 00 50       NEG    $50
E568: 00 D0       NEG    $D0
E56A: 00 00       NEG    $00
E56C: 03 70       COM    $70
E56E: 00 80       NEG    $80
E570: FE C0 00    LDU    $C000
E573: D0 00       SUBB   $00
E575: 00 03       NEG    $03
E577: 70 FF E0    NEG    $FFE0
E57A: FF 60 00    STU    $6000
E57D: D0 00       SUBB   $00
E57F: 00 03       NEG    $03
E581: 70 FF B0    NEG    $FFB0
E584: FF 90 00    STU    $9000
E587: D0 00       SUBB   $00
E589: 00 03       NEG    $03
E58B: 70 00 00    NEG    >$0000
E58E: FF 40 00    STU    $4000
E591: D0 00       SUBB   $00
E593: 00 03       NEG    $03
E595: 70 FF C0    NEG    $FFC0
E598: FF 80 00    STU    $8000
E59B: D0 00       SUBB   $00
E59D: 00 01       NEG    $01
E59F: 00 FE       NEG    $FE
E5A1: 80 FE       SUBA   #$FE
...
E5A7: 00 01       NEG    $01
E5A9: 50          NEGB
E5AA: FE C0 FF    LDU    $C0FF
E5AD: 00 02       NEG    $02
E5AF: 50          NEGB
E5B0: 01 00       NEG    $00
E5B2: 01 50       NEG    $50
E5B4: FF 50 FF    STU    $50FF
E5B7: 60 01       NEG    $1,X
E5B9: 60 02       NEG    $2,X
E5BB: 50          NEGB
E5BC: 00 B0       NEG    $B0
E5BE: FF 20 FF    STU    $20FF
E5C1: A0 01       SUBA   $1,X
E5C3: 50          NEGB
E5C4: 02 50       XNC    $50
E5C6: 00 B0       NEG    $B0
E5C8: FF 40 FF    STU    $40FF
E5CB: A0 01       SUBA   $1,X
E5CD: 30 02       LEAX   $2,X
E5CF: 50          NEGB
E5D0: 00 B0       NEG    $B0
E5D2: FF A0 FF    STU    $A0FF
E5D5: B0 00 C0    SUBA   >$00C0
E5D8: 01 40       NEG    $40
E5DA: 01 00       NEG    $00
E5DC: FE E0 00    LDU    $E000
E5DF: A0 00       SUBA   $0,X
E5E1: 90 02       SUBA   $02
E5E3: 50          NEGB
E5E4: 00 B0       NEG    $B0
E5E6: 00 00       NEG    $00
E5E8: FF A0 00    STU    $A000
E5EB: 70 00 00    NEG    >$0000
E5EE: 02 A0       XNC    $A0
E5F0: FF F0 FF    STU    $F0FF
E5F3: 50          NEGB
E5F4: 00 D0       NEG    $D0
E5F6: 00 00       NEG    $00
E5F8: 03 70       COM    $70
E5FA: 00 C0       NEG    $C0
E5FC: FE 80 00    LDU    $8000
E5FF: D0 00       SUBB   $00
E601: 00 01       NEG    $01
E603: A0 01       SUBA   $1,X
E605: 40          NEGA
E606: FE 00 00    LDU    >$0000
E609: D0 00       SUBB   $00
E60B: 00 02       NEG    $02
E60D: 40          NEGA
E60E: 01 40       NEG    $40
E610: FE 00 00    LDU    >$0000
E613: D0 00       SUBB   $00
E615: 00 02       NEG    $02
E617: 40          NEGA
E618: 00 B0       NEG    $B0
E61A: FE 90 00    LDU    $9000
E61D: D0 00       SUBB   $00
E61F: 00 03       NEG    $03
E621: 00 FF       NEG    $FF
E623: 00 00       NEG    $00
...
E628: 00 00       NEG    $00
E62A: 03 B0       COM    $B0
E62C: FF E0 FF    STU    $E0FF
E62F: 60 00       NEG    $0,X
E631: D0 00       SUBB   $00
E633: 00 02       NEG    $02
E635: C0 01       SUBB   #$01
E637: 50          NEGB
E638: FD E0 00    STD    $E000
E63B: E0 00       SUBB   $0,X
E63D: 00 01       NEG    $01
E63F: 80 00       SUBA   #$00
E641: 90 FE       SUBA   $FE
...
E646: 00 00       NEG    $00
E648: 02 C0       XNC    $C0
E64A: FE F0 00    LDU    $F000
E64D: 30 00       LEAX   $0,X
E64F: F0 00 00    SUBB   >$0000
E652: 03 10       COM    $10
E654: FF 00 00    STU    >$0000
E657: 40          NEGA
E658: 00 D0       NEG    $D0
E65A: 00 00       NEG    $00
E65C: 01 80       NEG    $80
E65E: FE 80 00    LDU    $8000
E661: 50          NEGB
E662: 01 40       NEG    $40
E664: 00 00       NEG    $00
E666: 01 80       NEG    $80
E668: FE 90 FF    LDU    $90FF
E66B: A0 01       SUBA   $1,X
E66D: E0 00       SUBB   $0,X
E66F: 00 02       NEG    $02
E671: E0 FE       SUBB   [W,S]
E673: A0 00       SUBA   $0,X
E675: 70 01 00    NEG    $0100
E678: 00 00       NEG    $00
E67A: 01 40       NEG    $40
E67C: FE E0 00    LDU    $E000
E67F: B0 00 80    SUBA   >$0080
E682: 00 00       NEG    $00
E684: 03 20       COM    $20
E686: FF 40 00    STU    $4000
E689: 00 00       NEG    $00
E68B: D0 00       SUBB   $00
E68D: 00 00       NEG    $00
E68F: 80 FF       SUBA   #$FF
...
E697: 00 03       NEG    $03
E699: 00 FE       NEG    $FE
E69B: F0 00 20    SUBB   >$0020
E69E: 01 00       NEG    $00
E6A0: 00 00       NEG    $00
E6A2: 01 00       NEG    $00
E6A4: FF C0 FF    STU    $C0FF
E6A7: 70 00 E0    NEG    >$00E0
E6AA: 00 00       NEG    $00
E6AC: 03 70       COM    $70
E6AE: FF A0 FF    STU    $A0FF
E6B1: A0 00       SUBA   $0,X
E6B3: D0 00       SUBB   $00
E6B5: F0 02 60    SUBB   $0260
E6B8: FE C0 00    LDU    $C000
E6BB: 50          NEGB
E6BC: 01 00       NEG    $00
E6BE: 00 00       NEG    $00
E6C0: 02 80       XNC    $80
E6C2: FF 60 FF    STU    $60FF
E6C5: B0 01 00    SUBA   $0100
E6C8: FC 10 01    LDD    $1001
E6CB: 40          NEGA
E6CC: 00 80       NEG    $80
E6CE: FE 90 01    LDU    $9001
E6D1: 00 01       NEG    $01
E6D3: A0 01       SUBA   $1,X
E6D5: 40          NEGA
E6D6: 00 80       NEG    $80
E6D8: FE 90 01    LDU    $9001
E6DB: 00 02       NEG    $02
E6DD: 20 01       BRA    $E6E0
E6DF: 40          NEGA
E6E0: 00 80       NEG    $80
E6E2: FE 90 01    LDU    $9001
E6E5: 00 02       NEG    $02
E6E7: 60 01       NEG    $1,X
E6E9: 40          NEGA
E6EA: 00 80       NEG    $80
E6EC: FE 90 01    LDU    $9001
E6EF: 00 02       NEG    $02
E6F1: 80 01       SUBA   #$01
E6F3: 40          NEGA
E6F4: 00 80       NEG    $80
E6F6: FE 90 01    LDU    $9001
E6F9: 00 02       NEG    $02
E6FB: C0 01       SUBB   #$01
E6FD: 40          NEGA
E6FE: 00 80       NEG    $80
E700: FE 90 01    LDU    $9001
E703: 00 00       NEG    $00
E705: 60 01       NEG    $1,X
E707: 60 FF 00 FE NEG    [$00FE]
E70B: 30 02       LEAX   $2,X
E70D: E0 00       SUBB   $0,X
E70F: 60 00       NEG    $0,X
E711: 40          NEGA
...
E722: 00 00       NEG    $00
E724: 01 40       NEG    $40
E726: FF 60 00    STU    $6000
E729: 60 01       NEG    $1,X
E72B: 40          NEGA
E72C: 02 F0       XNC    $F0
E72E: 00 80       NEG    $80
E730: 01 00       NEG    $00
E732: FE 30 01    LDU    $3001
E735: D0 00       SUBB   $00
E737: 00 01       NEG    $01
E739: 00 00       NEG    $00
E73B: 60 00       NEG    $0,X
...
E742: 01 00       NEG    $00
E744: 00 30       NEG    $30
E746: FF 30 01    STU    $3001
E749: A0 E7       SUBA   E,S
E74B: 52          XNCB
E74C: E7 92       STB    Illegal Postbyte
E74E: E7 D2       STB    Illegal Postbyte
E750: E8 12       EORB   -$E,X
E752: 82 82       SBCA   #$82
E754: 82 82       SBCA   #$82
E756: 82 82       SBCA   #$82
...
E9FE: EA 12       ORB    -$E,X
EA00: EB 1F       ADDB   -$1,X
EA02: EB BC EC    ADDB   [$E9F1,PCR]
EA05: 72 ED 25    XNC    $ED25
EA08: ED DE       STD    [W,U]
EA0A: EF 1D       STU    -$3,X
EA0C: EF BA       STU    [F,Y]
EA0E: F1 50 F2    CMPB   $50F2
EA11: B7 EA 5E    STA    $EA5E
EA14: EA 5F       ORB    -$1,U
EA16: EA 60       ORB    $0,S
EA18: EA 61       ORB    $1,S
EA1A: EA 62       ORB    $2,S
...
EAF6: 40          NEGA
EAF7: 04 40       LSR    $40
EAF9: 60 BF 40 04 NEG    [$4004]
EAFD: 40          NEGA
EAFE: A0 BF 49 00 SUBA   [$4900]
EB02: 40          NEGA
EB03: C0 9F       SUBB   #$9F
EB05: 40          NEGA
EB06: 1C 40       ANDCC  #$40
EB08: E0 BF 02 48 SUBB   [$0248]
EB0C: 00 80       NEG    $80
EB0E: 80 DF       SUBA   #$DF
EB10: 40          NEGA
EB11: 04 40       LSR    $40
...
EB3D: EB 86       ADDB   A,X
EB3F: EB 87       ADDB   E,X
EB41: EB 88 EB    ADDB   -$15,X
EB44: 89 EB       ADCA   #$EB
EB46: 8A EB       ORA    #$EB
EB48: 8B EB       ADDA   #$EB
EB4A: 8C EB 8D    CMPX   #$EB8D
EB4D: EB 8E       ADDB   W,X
EB4F: EB 8F       ADDB   ,W
EB51: EB 9A       ADDB   [F,X]
EB53: EB AA       ADDB   F,Y
EB55: EB AB       ADDB   D,Y
EB57: EB AC EB    ADDB   $EB45,PCR
EB5A: AD EB       JSR    D,S
EB5C: AE EB       LDX    D,S
EB5E: AF EB       STX    D,S
EB60: B0 EB B1    SUBA   $EBB1
EB63: EB B2       ADDB   Illegal Postbyte
EB65: EB B3       ADDB   [,--Y]
EB67: EB B4       ADDB   [,Y]
EB69: EB B5       ADDB   [B,Y]
EB6B: EB B6       ADDB   [A,Y]
EB6D: EB B7       ADDB   [E,Y]
EB6F: EB B8 EB    ADDB   [-$15,Y]
EB72: B9 EB BA    ADCA   $EBBA
EB75: EB BB       ADDB   [D,Y]
EB77: 00 00       NEG    $00
EB79: 00 00       NEG    $00
EB7B: 00 00       NEG    $00
...
EBBA: 00 00       NEG    $00
EBBC: EB E2       ADDB   ,-S
EBBE: EB E8 EB    ADDB   -$15,S
EBC1: FD EC 0D    STD    $EC0D
EBC4: EC 18       LDD    -$8,X
EBC6: EC 23       LDD    $3,Y
EBC8: EC 24       LDD    $4,Y
EBCA: EC 25       LDD    $5,Y
...
EBF9: 04 40       LSR    $40
EBFB: 40          NEGA
EBFC: BF 03 42    STX    $0342
EBFF: 04 40       LSR    $40
EC01: 40          NEGA
EC02: BF 42 00    STX    $4200
EC05: 80 C0       SUBA   #$C0
EC07: 5F          CLRB
EC08: 42          XNCA
EC09: 04 40       LSR    $40
...
EC3E: 04 80       LSR    $80
EC40: 40          NEGA
EC41: BF 42 00    STX    $4200
EC44: 80 80       SUBA   #$80
EC46: 5F          CLRB
EC47: 4A          DECA
EC48: 00 80       NEG    $80
EC4A: A0 9F 42 34 SUBA   [$4234]
EC4E: 80 C0       SUBA   #$C0
EC50: BF 00 00    STX    >$0000
EC53: 01 42       NEG    $42
EC55: 00 80       NEG    $80
EC57: C0 5F       SUBB   #$5F
EC59: 02 49       XNC    $49
...
EC84: EC C7       LDD    E,U
EC86: EC D7       LDD    [E,U]
EC88: EC DD EC DE LDD    [$D96A,PCR]
EC8C: EC DF EC E0 LDD    [$ECE0]
EC90: EC E1       LDD    ,S++
EC92: EC E2       LDD    ,-S
EC94: EC E3       LDD    ,--S
EC96: EC E4       LDD    ,S
...
EC9A: EC E6       LDD    A,S
EC9C: EC F1       LDD    [,S++]
EC9E: EC F2       LDD    Illegal Postbyte
ECA0: EC F3       LDD    [,--S]
ECA2: EC FE       LDD    [W,S]
ECA4: ED 0E       STD    $E,X
ECA6: ED 19       STD    -$7,X
...
ED04: 49          ROLA
ED05: 00 80       NEG    $80
ED07: A0 9F 42 14 SUBA   [$4214]
ED0B: 80 C0       SUBA   #$C0
ED0D: BF 02 42    STX    $0242
ED10: 00 80       NEG    $80
ED12: 40          NEGA
ED13: 5F          CLRB
ED14: 42          XNCA
...
EDC0: 41          NEGA
EDC1: 04 40       LSR    $40
EDC3: E0 BF 02 41 SUBB   [$0241]
EDC7: 04 40       LSR    $40
EDC9: 40          NEGA
EDCA: BF 41 00    STX    $4100
EDCD: 80 E0       SUBA   #$E0
EDCF: 5F          CLRB
EDD0: 02 41       XNC    $41
EDD2: 00 80       NEG    $80
...
EEF4: 40          NEGA
EEF5: 04 40       LSR    $40
EEF7: 60 BF 40 04 NEG    [$4004]
EEFB: 40          NEGA
EEFC: A0 BF 49 00 SUBA   [$4900]
EF00: 40          NEGA
EF01: C0 9F       SUBB   #$9F
EF03: 40          NEGA
EF04: 1C 40       ANDCC  #$40
EF06: E0 BF 02 48 SUBB   [$0248]
EF0A: 00 80       NEG    $80
EF0C: 80 DF       SUBA   #$DF
EF0E: 40          NEGA
EF0F: 04 40       LSR    $40
...
EF3F: EF 86       STU    A,X
EF41: EF 87       STU    E,X
EF43: EF 88 EF    STU    -$11,X
EF46: 89 EF       ADCA   #$EF
EF48: 8A EF       ORA    #$EF
EF4A: 8B EF       ADDA   #$EF
EF4C: 8C EF 8D    CMPX   #$EF8D
EF4F: EF 98 EF    STU    [-$11,X]
EF52: A8 EF       EORA   ,--W
EF54: A9 EF       ADCA   ,--W
EF56: AA EF       ORA    ,--W
EF58: AB EF       ADDA   ,--W
...
EF5E: AE EF       LDX    ,--W
EF60: AF EF       STX    ,--W
EF62: B0 EF B1    SUBA   $EFB1
EF65: EF B2       STU    Illegal Postbyte
EF67: EF B3       STU    [,--Y]
EF69: EF B4       STU    [,Y]
EF6B: EF B5       STU    [B,Y]
EF6D: EF B6       STU    [A,Y]
EF6F: EF B7       STU    [E,Y]
EF71: EF B8 EF    STU    [-$11,Y]
EF74: B9 00 00    ADCA   >$0000
EF77: 00 00       NEG    $00
EF79: 00 00       NEG    $00
EF7B: 00 00       NEG    $00
EF7D: 00 00       NEG    $00
...
EFB6: 00 00       NEG    $00
EFB8: 00 00       NEG    $00
EFBA: F0 36 F0    SUBB   $36F0
EFBD: 37 F0       PULU   X,Y,S,PC
EFBF: 38 F0       XANDCC #$F0
EFC1: 39          RTS
EFC2: F0 3A F0    SUBB   $3AF0
EFC5: 3B          RTI
EFC6: F0 3C F0    SUBB   $3CF0
EFC9: 3D          MUL
EFCA: F0 3E F0    SUBB   $3EF0
EFCD: 3F          SWI
EFCE: F0 40 F0    SUBB   $40F0
EFD1: 41          NEGA
EFD2: F0 42 F0    SUBB   $42F0
EFD5: 43          COMA
EFD6: F0 44 F0    SUBB   $44F0
EFD9: 45          LSRA
EFDA: F0 46 F0    SUBB   $46F0
EFDD: 47          ASRA
EFDE: F0 48 F0    SUBB   $48F0
EFE1: 49          ROLA
EFE2: F0 4A F0    SUBB   $4AF0
EFE5: 50          NEGB
EFE6: F0 56 F0    SUBB   $56F0
EFE9: 57          ASRB
EFEA: F0 5D F0    SUBB   $5DF0
EFED: 68 F0       ASL    [,--W]
EFEF: 6E F0       JMP    [,--W]
EFF1: 74 F0 98    LSR    $F098
EFF4: F0 9E F0    SUBB   $9EF0
EFF7: 9F F0       STX    $F0
EFF9: A0 F0       SUBA   [,--W]
EFFB: A6 F0       LDA    [,--W]
EFFD: BB F0 CB    ADDA   $F0CB
F000: F0 D6 F0    SUBB   $D6F0
F003: E1 F0       CMPB   [,--W]
F005: E2 F0       SBCB   [,--W]
F007: E3 F0       ADDD   [,--W]
F009: E9 F0       ADCB   [,--W]
F00B: FE F0 FF    LDU    $F0FF
F00E: F1 0F F1    CMPB   $0FF1
F011: 10 F1 11 F1 CMPB   $11F1
F015: 17 F1 22    LBSR   $E13A
F018: F1 2D F1    CMPB   $2DF1
F01B: 3D          MUL
F01C: F1 3E F1    CMPB   $3EF1
F01F: 3F          SWI
F020: F1 40 F1    CMPB   $40F1
F023: 46          RORA
F024: F1 47 F1    CMPB   $47F1
F027: 48          ASLA
F028: F1 49 F1    CMPB   $49F1
F02B: 4A          DECA
F02C: F1 4B F1    CMPB   $4BF1
F02F: 4C          INCA
F030: F1 4D F1    CMPB   $4DF1
F033: 4E          XCLRA
F034: F1 4F 00    CMPB   $4F00
F037: 00 00       NEG    $00
F039: 00 00       NEG    $00
F03B: 00 00       NEG    $00
F03D: 00 00       NEG    $00
...
F0B7: 04 40       LSR    $40
F0B9: 40          NEGA
F0BA: BF 03 42    STX    $0342
F0BD: 04 40       LSR    $40
F0BF: 40          NEGA
F0C0: BF 42 00    STX    $4200
F0C3: 80 C0       SUBA   #$C0
F0C5: 5F          CLRB
F0C6: 42          XNCA
F0C7: 04 40       LSR    $40
...
F0EB: 04 40       LSR    $40
F0ED: 40          NEGA
F0EE: BF 42 00    STX    $4200
F0F1: 80 80       SUBA   #$80
F0F3: 5F          CLRB
F0F4: 4A          DECA
F0F5: 00 40       NEG    $40
F0F7: A0 9F 42 2C SUBA   [$422C]
F0FB: 40          NEGA
F0FC: C0 BF       SUBB   #$BF
F0FE: 00 03       NEG    $03
F100: 42          XNCA
...
F14C: 00 00       NEG    $00
F14E: 00 00       NEG    $00
F150: F1 EC F1    CMPB   $ECF1
F153: ED F1       STD    [,S++]
F155: EE F1       LDU    [,S++]
F157: EF F1       STU    [,S++]
F159: F0 F1 F1    SUBB   $F1F1
F15C: F1 F2 F1    CMPB   $F2F1
F15F: F3 F1 F4    ADDD   $F1F4
F162: F1 F5 F1    CMPB   $F5F1
F165: F6 F1 F7    LDB    $F1F7
F168: F1 F8 F1    CMPB   $F8F1
F16B: F9 F1 FA    ADCB   $F1FA
F16E: F1 FB F1    CMPB   $FBF1
F171: FC F1 FD    LDD    $F1FD
F174: F1 FE F1    CMPB   $FEF1
F177: FF F2 00    STU    $F200
F17A: F2 01 F2    SBCB   $01F2
F17D: 02 F2       XNC    $F2
F17F: 12          NOP
F180: F2 1D F2    SBCB   $1DF2
F183: 1E F2       EXG    inv,Y
F185: 1F F2       TFR    inv,Y
F187: 20 F2       BRA    $F17B
F189: 21 F2       BRN    $F17D
F18B: 22 F2       BHI    $F17F
F18D: 23 F2       BLS    $F181
...
F195: 27 F2       BEQ    $F189
F197: 28 F2       BVC    $F18B
F199: 33 F2       LEAU   Illegal Postbyte
F19B: 34 F2       PSHS   PC,U,Y,X,A
F19D: 35 F2       PULS   A,X,Y,U,PC
F19F: 36 F2       PSHU   PC,S,Y,X,A
F1A1: 37 F2       PULU   A,X,Y,S,PC
F1A3: 38 F2       XANDCC #$F2
F1A5: 39          RTS
F1A6: F2 44 F2    SBCB   $44F2
F1A9: 45          LSRA
F1AA: F2 50 F2    SBCB   $50F2
F1AD: 51          NEGB
F1AE: F2 57 F2    SBCB   $57F2
F1B1: 5D          TSTB
F1B2: F2 68 F2    SBCB   $68F2
F1B5: 69 F2       ROL    Illegal Postbyte
F1B7: 6A F2       DEC    Illegal Postbyte
F1B9: 6B F2       XDEC   Illegal Postbyte
F1BB: 6C F2       INC    Illegal Postbyte
F1BD: 6D F2       TST    Illegal Postbyte
F1BF: 73 F2 79    COM    $F279
F1C2: F2 7F F2    SBCB   $7FF2
F1C5: 85 F2       BITA   #$F2
F1C7: 90 F2       SUBA   $F2
F1C9: 9B F2       ADDA   $F2
F1CB: 9C F2       CMPX   $F2
...
F1CF: 9E F2       LDX    $F2
F1D1: 9F F2       STX    $F2
F1D3: A0 F2       SUBA   Illegal Postbyte
F1D5: A1 F2       CMPA   Illegal Postbyte
F1D7: A7 F2       STA    Illegal Postbyte
F1D9: A8 F2       EORA   Illegal Postbyte
F1DB: AE F2       LDX    Illegal Postbyte
F1DD: AF F2       STX    Illegal Postbyte
F1DF: B0 F2 B1    SUBA   $F2B1
F1E2: F2 B2 F2    SBCB   $B2F2
F1E5: B3 F2 B4    SUBD   $F2B4
F1E8: F2 B5 F2    SBCB   $B5F2
F1EB: B6 00 00    LDA    >$0000
F1EE: 00 00       NEG    $00
F1F0: 00 00       NEG    $00
F1F2: 00 00       NEG    $00
F1F4: 00 00       NEG    $00
...
F2B8: DD F2       STD    $F2
F2BA: DE F2       LDU    $F2
F2BC: F8 F2 F9    EORB   $F2F9
F2BF: F3 09 F3    ADDD   $09F3
F2C2: 23 F3       BLS    $F2B7
F2C4: 29 F3       BVS    $F2B9
F2C6: 2A F3       BPL    $F2BB
F2C8: 3F          SWI
F2C9: F3 40 F3    ADDD   $40F3
F2CC: 5A          DECB
F2CD: F3 65 F3    ADDD   $65F3
F2D0: 75 F3 76    LSR    $F376
F2D3: F3 77 F3    ADDD   $77F3
F2D6: 78 F3 79    ASL    $F379
F2D9: F3 7A F3    ADDD   $7AF3
F2DC: 7B 00 05    XDEC   >$0005
F2DF: 43          COMA
F2E0: 00 80       NEG    $80
F2E2: 00 5F       NEG    $5F
F2E4: 43          COMA
...
F355: 41          NEGA
F356: 04 40       LSR    $40
F358: E0 BF 02 41 SUBB   [$0241]
F35C: 04 40       LSR    $40
F35E: 40          NEGA
F35F: BF 41 00    STX    $4100
F362: 80 E0       SUBA   #$E0
F364: 5F          CLRB
F365: 03 41       COM    $41
F367: 00 80       NEG    $80
...
F37B: 01 50       NEG    $50
F37D: 00 80       NEG    $80
F37F: 70 37 F3    NEG    $37F3
F382: E9 F3       ADCB   [,--S]
F384: 97 F3       STA    $F3
F386: A2 F3       SBCA   [,--S]
F388: B2 F3 BD    SBCA   $F3BD
F38B: F3 DE F3    ADDD   $DEF3
F38E: B2 F3 BD    SBCA   $F3BD
F391: F3 B2 F3    ADDD   $B2F3
F394: BD F3 CE    JSR    $F3CE
F397: 02 51       XNC    $51
F399: 00 C0       NEG    $C0
F39B: 30 47       LEAX   $7,U
F39D: 52          XNCB
F39E: 00 C0       NEG    $C0
F3A0: 70 47 03    NEG    $4703
F3A3: 53          COMB
F3A4: 00 C0       NEG    $C0
F3A6: 60 47       NEG    $7,U
F3A8: 54          LSRB
