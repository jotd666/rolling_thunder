...
8943: 48          ASLA
8944: AD D6       JSR    [A,U]        ; [indirect_jump]
...
8952: 48          ASLA
8953: AD D6       JSR    [A,U]        ; [indirect_jump]
8955: C6 FC       LDB    #$FC
...
9111: 48          ASLA
9112: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
924F: 48          ASLA
9250: AD D6       JSR    [A,U]        ; [indirect_jump]
...
9914: 48          ASLA
9915: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
9BFE: 48          ASLA
9BFF: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
9E41: 96 06       LDA    $06
9E43: 48          ASLA
9E44: 6E D6       JMP    [A,U]        ; [indirect_jump]
9E46: 0C 04       INC    $04
9E48: 0F 06       CLR    $06
9E4A: 0C 05       INC    $05
9E4C: 0F 07       CLR    $07
...
A17A: 48          ASLA
A17B: 6E D6       JMP    [A,U]        ; [indirect_jump]
A17D: A1 85       CMPA   B,X
A17F: A1 8F       CMPA   ,W
A181: A1 9E       CMPA   [W,X]
...
A6DD: 96 06       LDA    $06
A6DF: 48          ASLA
A6E0: 6E D6       JMP    [A,U]        ; [indirect_jump]
A6E2: A6 E6       LDA    A,S
...
A8CF: 48          ASLA
A8D0: 6E D6       JMP    [A,U]        ; [indirect_jump]
A8D2: A8 E6       EORA   A,S
A8D4: A9 58       ADCA   -$8,U
A8D6: A9 FE       ADCA   [W,S]
A8D8: AA 1E       ORA    -$2,X
...
AC88: 48          ASLA
AC89: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
B422: 84 1C       ANDA   #$1C
B424: 44          LSRA
B425: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
B643: CE B6 64    LDU    #jump_table_b664
B646: A6 84       LDA    ,X
B648: 80 20       SUBA   #$20
B64A: 84 7C       ANDA   #$7C
B64C: 44          LSRA
...
B655: C4 FC       ANDB   #$FC
B657: 54          LSRB
B658: AD D5       JSR    [B,U]        ; [indirect_jump]
B65A: 0A 3A       DEC    $3A
B65C: 26 01       BNE    $B65F
B65E: 39          RTS
...
B8B0: 84 7C       ANDA   #$7C
B8B2: 44          LSRA
B8B3: EE C6       LDU    A,U   ; [breakpoint] select proper table
...
B8CD: C4 FC       ANDB   #$FC
B8CF: 54          LSRB
B8D0: 6E D5       JMP    [B,U]        ; [indirect_jump]
B8D2: 39          RTS
...
BF3F: A6 09       LDA    $9,X
BF41: 48          ASLA
BF42: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
BFAC: A6 09       LDA    $9,X
BFAE: 48          ASLA
BFAF: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C053: A6 09       LDA    $9,X
C055: 48          ASLA
C056: 6E D6       JMP    [A,U]        ; [indirect_jump]
C058: C0 5E       SUBB   #$5E
C05A: C0 76       SUBB   #$76
C05C: C0 82       SUBB   #$82
...
C0CB: A6 09       LDA    $9,X
C0CD: 48          ASLA
C0CE: 6E D6       JMP    [A,U]        ; [indirect_jump]
C0D0: C0 DA       SUBB   #$DA
C0D2: C0 E8       SUBB   #$E8
C0D4: C0 DA       SUBB   #$DA
C0D6: C1 13       CMPB   #$13
...
C15C: A6 09       LDA    $9,X
C15E: 48          ASLA
C15F: 6E D6       JMP    [A,U]        ; [indirect_jump]
C161: C1 67       CMPB   #$67
C163: C1 85       CMPB   #$85
C165: C1 97       CMPB   #$97
...
C1D9: A6 09       LDA    $9,X
C1DB: 48          ASLA
C1DC: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C230: A6 09       LDA    $9,X
C232: 48          ASLA
C233: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C29A: A6 09       LDA    $9,X
C29C: 48          ASLA
C29D: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C31B: A6 09       LDA    $9,X
C31D: 48          ASLA
C31E: 6E D6       JMP    [A,U]        ; [indirect_jump]
C320: EC 18       LDD    -$8,X
C322: C4 F8       ANDB   #$F8
...
C3A9: A6 09       LDA    $9,X
C3AB: 48          ASLA
C3AC: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C3F9: A6 09       LDA    $9,X
C3FB: 48          ASLA
C3FC: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C5B5: A6 09       LDA    $9,X
C5B7: 48          ASLA
C5B8: 6E D6       JMP    [A,U]        ; [indirect_jump]
C5BA: C5 C4       BITB   #$C4
C5BC: C5 C4       BITB   #$C4
C5BE: C5 C4       BITB   #$C4
C5C0: C5 C4       BITB   #$C4
...
C740: A6 09       LDA    $9,X
C742: 48          ASLA
C743: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C76B: A6 09       LDA    $9,X
C76D: 48          ASLA
C76E: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
C7E9: A6 09       LDA    $9,X
C7EB: 48          ASLA
C7EC: 6E D6       JMP    [A,U]        ; [indirect_jump]
C7F6: A6 01       LDA    $1,X
C7F8: 88 03       EORA   #$03
C7FA: A7 01       STA    $1,X
C7FC: A7 07       STA    $7,X
...
C8A3: A6 09       LDA    $9,X
C8A5: 48          ASLA
C8A6: 6E D6       JMP    [A,U]        ; [indirect_jump]
C8B4: 6A 0A       DEC    $A,X
C8B6: 27 01       BEQ    $C8B9
C8B8: 39          RTS
...
CA42: A6 09       LDA    $9,X
CA44: 48          ASLA
CA45: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
CAEF: 44          LSRA
CAF0: 44          LSRA
CAF1: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
CD76: A6 09       LDA    $9,X
CD78: 48          ASLA
CD79: 6E D6       JMP    [A,U]        ; [indirect_jump]
CD7B: 6A 0A       DEC    $A,X
CD7D: 27 01       BEQ    $CD80
CD7F: 39          RTS
...
CE3C: A6 09       LDA    $9,X
CE3E: 48          ASLA
CE3F: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
CEEF: A6 09       LDA    $9,X
CEF1: 48          ASLA
CEF2: 6E D6       JMP    [A,U]        ; [indirect_jump]
CEF4: 6A 0A       DEC    $A,X
CEF6: 27 01       BEQ    $CEF9
CEF8: 39          RTS
...
CF70: A6 09       LDA    $9,X
CF72: 48          ASLA
CF73: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D038: A6 09       LDA    $9,X
D03A: 48          ASLA
D03B: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D095: A6 09       LDA    $9,X
D097: 48          ASLA
D098: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D10D: A6 09       LDA    $9,X
D10F: 48          ASLA
D110: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D136: A6 09       LDA    $9,X
D138: 48          ASLA
D139: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D20B: A6 09       LDA    $9,X
D20D: 48          ASLA
D20E: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D2D0: 96 60       LDA    $60
D2D2: 48          ASLA
D2D3: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D391: 96 60       LDA    $60
D393: 48          ASLA
D394: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
D65A: A6 84       LDA    ,X
D65C: AD D6       JSR    [A,U]        ; [indirect_jump]
D65E: 20 EA       BRA    $D64A
D660: D6 6A       LDB    $6A
D662: D6 72       LDB    $72
D664: D6 97       LDB    $97
...
D85F: 80 48       SUBA   #$48
D861: 48          ASLA
D862: AD D6       JSR    [A,U]        ; [indirect_jump]
D864: 0A 54       DEC    $54
D866: 26 01       BNE    $D869
D868: 39          RTS
...
D8FA: A6 02       LDA    $2,X  ; [breakpoint]
D8FC: 48          ASLA
D8FD: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
DACD: 80 70       SUBA   #$70
DACF: 48          ASLA
DAD0: AD D6       JSR    [A,U]        ; [indirect_jump]
DAD2: 0A 47       DEC    $47
DAD4: 26 01       BNE    $DAD7
DAD6: 39          RTS
...
DB03: A6 02       LDA    $2,X
DB05: 48          ASLA
DB06: 6E D6       JMP    [A,U]        ; [indirect_jump]

DB0E: BD DD 8E    JSR    $DD8E
DB11: CE DB 19    LDU    #jump_table_db19
DB14: A6 02       LDA    $2,X
DB16: 48          ASLA
DB17: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
DBF4: A6 02       LDA    $2,X
DBF6: 48          ASLA
DBF7: 6E D6       JMP    [A,U]        ; [indirect_jump]

DBFD: BD DD 8E    JSR    $DD8E
DC00: CE DC 08    LDU    #jump_table_dc08
DC03: A6 02       LDA    $2,X
DC05: 48          ASLA
DC06: 6E D6       JMP    [A,U]        ; [indirect_jump]
...
DCD6: A6 02       LDA    $2,X
DCD8: 48          ASLA
DCD9: 6E D6       JMP    [A,U]        ; [indirect_jump]
